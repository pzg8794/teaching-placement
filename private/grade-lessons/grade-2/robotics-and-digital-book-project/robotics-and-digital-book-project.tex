...
Sphero Indi robotics paired with Book Creator documentation or storytelling.

\section*{Learning Targets}
\begin{itemize}[leftmargin=*]
\item Students program a robot through a short guided task.
\item Students capture or describe their learning in a digital book format.
\item Students share one successful robot or storytelling choice.
\end{itemize}
...
\item Book Creator or equivalent tool
\end{itemize}
