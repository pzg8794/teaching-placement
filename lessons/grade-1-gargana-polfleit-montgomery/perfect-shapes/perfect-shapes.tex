...
\item Reference file: perfect-shapes.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: Paper | Pencils | Chromebooks | Drawing App (Chrome Canvas) | Chart paper or someplace to record student thinking
