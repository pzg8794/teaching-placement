...
\item Reference file: sending-messages-with-light.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: flashlights (1 per pair) | chart paper | markers | whiteboard or paper for students | Light Code Key (Prepare on chart paper or Individual handouts)
