...
\item Reference file: 1st-grade-final-project.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: Planning Page: Final Project - 1st (PRINT) | | Rubric (in lesson) | | Variety of mterials through the year based on student choice
