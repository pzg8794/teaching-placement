\documentclass[11pt]{article}
    ...
    \item Reference file: protecting-your-secret-identity.bib
    \end{itemize}
    \section*{School Planning Goals and Inclusion}
    \begin{itemize}[leftmargin=*]
    \item What is expected: I can compare and contrast behaviors that do and do not keep information secure.
