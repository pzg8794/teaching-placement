...
\item Grade: Grade 3
\item Workbook sessions: Session 35
...
\item Reference file: finalize-and-present-project.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: I can check my Google Site to make sure it is correct and clear. | | I can share and present my completed site.
