...
\item Reference file: lunchtime-data.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: I can collect information from several resources to determine the different ways data can be collected.
