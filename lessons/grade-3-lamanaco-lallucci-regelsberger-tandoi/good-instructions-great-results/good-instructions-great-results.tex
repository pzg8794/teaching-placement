...
\item Reference file: good-instructions-great-results.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: I can create a model of an object and then identify the patterns and essential elements of it.
