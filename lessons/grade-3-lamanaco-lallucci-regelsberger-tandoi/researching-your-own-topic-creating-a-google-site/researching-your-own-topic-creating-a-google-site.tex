...
\item Reference file: researching-your-own-topic-creating-a-google-site.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: I can find facts that support my opinion. | | I can write notes about my facts. | | I can edit a homepage text, and add sections.
