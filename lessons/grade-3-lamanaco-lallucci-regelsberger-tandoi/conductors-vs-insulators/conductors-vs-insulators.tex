...
\item Reference file: conductors-vs-insulators.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: I can define conductor and insulator. | I can identify examples of conductors and insulators. | I can explain the difference between a conductor and an insulator in terms of electricity flow. | I can predict whether a given material is a conductor or insulator through experimentation.
