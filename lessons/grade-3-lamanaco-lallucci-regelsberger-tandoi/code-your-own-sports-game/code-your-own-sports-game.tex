...
\item Reference file: code-your-own-sports-game.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: I can find and fix errors in my algorithm | I can make a game that does something (output) based on what I tell it to do (input)
