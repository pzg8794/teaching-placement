\documentclass[11pt]{article}
    ...
    \item Reference file: intro-to-sequencing-k.bib
    \end{itemize}
    \section*{School Planning Goals and Inclusion}
    \begin{itemize}[leftmargin=*]
    \item What is expected: I can tell the steps needed to complete a daily task. (K-1.CT.4 Identify a problem or task and discuss ways to break it into multiple smaller steps.) | I can work with others to make a plan with steps to complete a task (K-1.CT.10 Collaboratively create a plan that outlines the steps needed to complete a task.)
