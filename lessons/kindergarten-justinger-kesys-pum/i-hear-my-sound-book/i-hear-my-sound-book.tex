...
\item Reference file: i-hear-my-sound-book.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: K-1.DL.1: Use digital tools to create and communicate | K-1.IC.6: With teacher support, identify different ways people interact with computers and computing devices | K-1.DL.2: With teacher guidance, navigate and use common features of digital tools and environments | K-1.IC.3: Identify computing technologies in the classroom, home, and community.
