\documentclass[11pt]{article}
    ...
    \item Reference file: book-creator-and-me-k-1.bib
    \end{itemize}
    \section*{School Planning Goals and Inclusion}
    \begin{itemize}[leftmargin=*]
    \item What is expected: K-1.DL.4: I can create a digital book | I can learn to use a variety of digital tools
