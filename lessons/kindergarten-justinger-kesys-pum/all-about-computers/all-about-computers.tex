...
\item Workbook sessions: Session 8
\item Class blocks: Day 1 12:25-1:15 Justinger, Day 2 12:25-1:15 Kesys, Day 4 12:25-1:15 Pum
\item Reference file: all-about-computers.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: K-1.NSD.1: I can identify ways people provide input and get output from computing devices. | K-1.NSD.2: I can name/label parts of a chromebook (computer hardware) | K-1.CY.1: I can identify reasons for keeping information private | K-1.CY.2: I can identify simple ways to keep my account secure
