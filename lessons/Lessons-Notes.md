...
> **📌 What This Is:** The single lesson home for this workspace. Grade lesson folders live here, and source materials or evidence live inside this same lessons tree.
> **🧭 Start Here When:** You want to stay inside one lesson directory instead of bouncing between separate packet, source, and evidence systems.
> **👀 Best Use:** Start with a grade folder, open the lesson you need, then use the evidence links or source-material links from inside that lesson.
...
- Open the **grade** first when you know the class.
- Open the **lesson folder** next; that folder should hold the packet files directly.
- Use the lesson’s `.md` file as the navigation page for packet content, source references, and evidence.
