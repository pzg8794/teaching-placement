# 🔴 Lego Spike Protect the Environment
...
- **LaTeX source:** [lego-spike-protect-the-environment.tex](./lego-spike-protect-the-environment.tex)
- **Bib file:** [lego-spike-protect-the-environment.bib](./lego-spike-protect-the-environment.bib)

## 🎯 School Planning Goals + Inclusion

- **What is expected:** I can explain how an object's speed is related to its energy, using evidence. | I can create explain how to protect the environment | I can iterate and test my models to improve them.
