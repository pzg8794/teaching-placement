\documentclass[11pt]{article}
    ...
    \item Reference file: dont-go-phishing-with-the-enemy.bib
    \end{itemize}
    \section*{School Planning Goals and Inclusion}
    \begin{itemize}[leftmargin=*]
    \item What is expected: I can explain what suspicious behavior looks like in common applications and devices, including suspicious data/links, virus, and malware.
