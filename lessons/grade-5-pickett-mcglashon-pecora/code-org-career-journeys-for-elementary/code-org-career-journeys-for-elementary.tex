\documentclass[11pt]{article}
    ...
    \item Reference file: code-org-career-journeys-for-elementary.bib
    \end{itemize}
    \section*{School Planning Goals and Inclusion}
    \begin{itemize}[leftmargin=*]
    \item What is expected: I can identify information that I need to change as I create my program | I can develop a model of my future career by changing inputs to get the output I want
