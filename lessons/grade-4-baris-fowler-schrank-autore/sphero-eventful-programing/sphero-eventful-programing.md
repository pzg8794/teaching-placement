...
- **Workbook sessions:** `Session 28`
- **Months:** April
- **Class blocks:** Day 1 `1:15-2:10` Baris, Day 2 `1:15-2:10` Fowler, Day 3 `1:15-2:10` Schrank, Day 4 `1:15-2:10` Autore
- **LaTeX source:** [sphero-eventful-programing.tex](./sphero-eventful-programing.tex)
- **Bib file:** [sphero-eventful-programing.bib](./sphero-eventful-programing.bib)

## 🎯 School Planning Goals + Inclusion

- **What is expected:** - I can Develop algorithms or programs that use repetition and conditionals. | - I can Decompose a problem into smaller named tasks
