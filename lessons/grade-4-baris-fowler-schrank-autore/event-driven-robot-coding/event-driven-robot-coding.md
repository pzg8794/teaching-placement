...
- **Compiled PDF:** [event-driven-robot-coding.pdf](./event-driven-robot-coding.pdf)
...
- Open with a short model that names the lesson focus: robot sensors, event-response logic, and debugging input-output behaviors.
