...
\item Grade: Grade 4
\item Workbook sessions: Session 3, Session 4, Session 5, Session 6
\item Class blocks: Day 1 1:15-2:10 Baris, Day 2 1:15-2:10 Fowler, Day 3 1:15-2:10 Schrank, Day 4 1:15-2:10 Autore
\item Reference file: harness-the-wind.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: - Understand the concept of wind as a renewable energy source. | - Identify the parts of a windmill and their function. | - Explore how windmills convert energy into mechanical motion. | - Demonstrate the engineering design process through building and testing their windmill.
