...
\item Reference file: google-slides-monopoly.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: - I can use Google Slides to create a digital artifact | - I can explain the purpose of cryptography
