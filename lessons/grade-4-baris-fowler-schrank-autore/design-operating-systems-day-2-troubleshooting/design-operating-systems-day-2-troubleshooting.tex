...
\item Reference file: design-operating-systems-day-2-troubleshooting.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: - I can determine possible solutions to solve common chromebook problems (troubleshooting).
