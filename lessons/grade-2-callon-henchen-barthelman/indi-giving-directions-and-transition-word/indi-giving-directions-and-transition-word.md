# 🟢 Indi: Giving directions & transition word
...
- **LaTeX source:** [indi-giving-directions-and-transition-word.tex](./indi-giving-directions-and-transition-word.tex)
- **Bib file:** [indi-giving-directions-and-transition-word.bib](./indi-giving-directions-and-transition-word.bib)

## 🎯 School Planning Goals + Inclusion

- **What is expected:** I can give clear directions, using transitions words to get from one place to another. | | I can use details (from my partners directions) to perform a task. | | I can develop and document a plan to get Indi to a certain location.
