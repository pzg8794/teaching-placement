...
\item Grade: Grade 2
\item Workbook sessions: Session 3
\item Class blocks: Day 1 10:45-11:35 Callon, Day 1 2:15-3:05 Henchen, Day 4 10:45-11:35 Barthelman
\item Reference file: what-is-an-architect-engineer-and-design-process-quick-bridge-design.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: I can define a choice board and explain its purpose in learning. | | I can describe the function of a QR code and demonstrate how to scan and access information using a QR code.
