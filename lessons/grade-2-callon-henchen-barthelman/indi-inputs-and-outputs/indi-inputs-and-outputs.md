...
- **What is expected:** I can demonstrate how Indi functions using inputs (color tiles) and output (travels in different directions. | | I can create two or more algorithms (paths) to get Indi to a location
