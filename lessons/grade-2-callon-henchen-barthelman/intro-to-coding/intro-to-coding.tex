\documentclass[11pt]{article}
    ...
    \item Reference file: intro-to-coding.bib
    \end{itemize}
    \section*{School Planning Goals and Inclusion}
    \begin{itemize}[leftmargin=*]
    \item What is expected: I can create two or more algorithms for the same task. | | I can identify and debug errors within an algorithm or program that include sequencing. | | I can develop and document a plan that outlines specific steps taken to complete a project.
