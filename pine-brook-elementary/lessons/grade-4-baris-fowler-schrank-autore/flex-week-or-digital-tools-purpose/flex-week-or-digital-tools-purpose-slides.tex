...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge FLEX Week | Or Digital Tools/Purpose\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on flex week | or digital tools/purpose. Watch first, then try it with me.
