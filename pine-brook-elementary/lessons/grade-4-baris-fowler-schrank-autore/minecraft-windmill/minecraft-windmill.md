...
- **LaTeX source:** [minecraft-windmill.tex](./minecraft-windmill.tex)
- **Bib file:** [minecraft-windmill.bib](./minecraft-windmill.bib)
- **Audience profile:** [class-audience-profile.md](../class-audience-profile.md)
- **Student slides (LaTeX):** [minecraft-windmill-slides.tex](./minecraft-windmill-slides.tex)
- **Student slides (PDF):** [minecraft-windmill-slides.pdf](./minecraft-windmill-slides.pdf)

## 🎯 School Planning Goals + Inclusion

- **What is expected:** - I can develop a computational model that shows changes in output when there are changes in input (4-6.CT.1)
...
- Today we are working on minecraft: windmill. Watch first, then try it with me.
