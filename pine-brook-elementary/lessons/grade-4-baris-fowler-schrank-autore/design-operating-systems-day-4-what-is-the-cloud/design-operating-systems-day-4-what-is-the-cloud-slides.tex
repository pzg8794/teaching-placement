...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Design Operating Systems | Day 4: What is the Cloud?\par}
\vspace{0.3cm}
...
\begin{itemize}
\item I can describe how data can be stored on a device or on a cloud.
\end{itemize}
...
\footnotesize
\begin{itemize}
\item Today we are working on design operating systems | day 4: what is the cloud?. Watch first, then try it with me.
