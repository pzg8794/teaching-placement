...
\item Reference file: design-operating-systems-day-4-what-is-the-cloud.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: - I can describe how data can be stored on a device or on a cloud.
