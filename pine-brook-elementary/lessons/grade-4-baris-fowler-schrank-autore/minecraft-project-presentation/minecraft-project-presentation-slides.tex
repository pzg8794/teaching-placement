...
\title{Minecraft Project Presentation}
...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Minecraft Project Presentation\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on minecraft project presentation. Watch first, then try it with me.
