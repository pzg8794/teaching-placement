\documentclass[11pt]{article}
    ...
    \item Grade: Grade 4
    \item Workbook sessions: Session 34
    \item Class blocks: Day 1 1:15-2:10 Baris, Day 2 1:15-2:10 Fowler, Day 3 1:15-2:10 Schrank, Day 4 1:15-2:10 Autore
    \item Reference file: minecraft-project-presentation.bib
    \end{itemize}
    \section*{School Planning Goals and Inclusion}
    \begin{itemize}[leftmargin=*]
    \item What is expected: - I can notice similarities and differences between design structures | - I can critically analyse strengths and weakness of designs
