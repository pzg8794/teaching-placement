...
- **Student slides (LaTeX):** [sphero-eventful-programing-slides.tex](./sphero-eventful-programing-slides.tex)
- **Student slides (PDF):** [sphero-eventful-programing-slides.pdf](./sphero-eventful-programing-slides.pdf)
...
- Today we are working on sphero eventful programing. Watch first, then try it with me.
