...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Sphero Eventful Programing\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on sphero eventful programing. Watch first, then try it with me.
