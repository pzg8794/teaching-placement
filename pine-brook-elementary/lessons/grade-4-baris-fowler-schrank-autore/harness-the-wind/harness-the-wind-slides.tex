...
\end{tikzpicture}
\end{center}
\note{Today we are working on harness the wind}
\end{frame}
...
\Large - Understand the concept of wind as a renewable energy source.
\end{block}
\begin{itemize}\large
\item - Understand the concept of wind as a renewable energy source.
\item - Identify the parts of a windmill and their function.
\item - Explore how windmills convert energy into mechanical motion.
\end{itemize}
\column{0.4\textwidth}
