...
- **Workbook sessions:** `Session 3, Session 4, Session 5, Session 6`
- **Months:** September, October
- **Class blocks:** Day 1 `1:15-2:10` Baris, Day 2 `1:15-2:10` Fowler, Day 3 `1:15-2:10` Schrank, Day 4 `1:15-2:10` Autore
- **LaTeX source:** [harness-the-wind.tex](./harness-the-wind.tex)
- **Bib file:** [harness-the-wind.bib](./harness-the-wind.bib)
...
- **Cross-curricular context:** 4 - ARC: Bravery and Your Brain (Literacy Lab) | 6-8 weeks | 4- Math: Whole Numbers: Place Value, Comparison, Addition, and Subtraction | (Sept 11 - Oct 17); 4 - ARC: Bravery and Your Brain (Literacy Lab) | 6-8 weeks | 4 - Science: Riding the Waves (Mid-Oct. - Mid-Nov.) | 4- Math: Operations: Multiplication, Division, and Algebraic Thinking | (Oct 18 - Nov 21)
- **Audience profile:** [class-audience-profile.md](../class-audience-profile.md)
- **Student slides (LaTeX):** [harness-the-wind-slides.tex](./harness-the-wind-slides.tex)
- **Student slides (PDF):** [harness-the-wind-slides.pdf](./harness-the-wind-slides.pdf)
...
- Today we are working on harness the wind. Watch first, then try it with me.
