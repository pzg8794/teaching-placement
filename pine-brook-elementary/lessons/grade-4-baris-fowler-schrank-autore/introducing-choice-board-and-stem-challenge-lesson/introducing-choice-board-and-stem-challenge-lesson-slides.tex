...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Introducing Choice Board \& STEM Challenge Lesson\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on introducing choice board \& stem challenge lesson. Watch first, then try it with me.
