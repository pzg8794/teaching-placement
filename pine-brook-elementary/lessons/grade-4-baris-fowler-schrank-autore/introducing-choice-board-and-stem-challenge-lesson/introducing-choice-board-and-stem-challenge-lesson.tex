...
\item Reference file: introducing-choice-board-and-stem-challenge-lesson.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: - I can design and build a contraption that will meet the requirements of the assignment and fit in the required work area. | - I can rethink my ideas to improve my design | - I can describe the steps taken and choices made to design and develop a solution using the design process. (4-6.CT.10)
