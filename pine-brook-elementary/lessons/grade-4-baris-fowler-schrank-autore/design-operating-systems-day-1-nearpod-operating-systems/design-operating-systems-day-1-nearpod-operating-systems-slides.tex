...
\title{Design Operating Systems | Day 1: Nearpod Operating Systems}
...
{\huge\bfseries\color{ink} Design Operating Systems | Day 1: Nearpod Operating Systems\par}
\vspace{0.2cm}
...
\end{center}
\end{columns}
\note{Audience guidance: Intermediate learners who can handle complex digital tasks when setup friction, debugging, and persistence are explicitly. Teaching move: Name the goal in student language before materials or devices create extra noise.}
\end{frame}
