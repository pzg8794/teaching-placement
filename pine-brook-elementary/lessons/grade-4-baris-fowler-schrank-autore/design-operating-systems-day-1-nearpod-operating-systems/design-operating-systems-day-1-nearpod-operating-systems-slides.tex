...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Design Operating Systems | Day 1: Nearpod Operating Systems\par}
\vspace{0.3cm}
...
\begin{itemize}
\item I can define what an operating system is
\item I can identify the most common operating systems
\item I can explain the functions of an operating system
\end{itemize}
...
\footnotesize
\begin{itemize}
\item Today we are working on design operating systems | day 1: nearpod operating systems. Watch first, then try it with me.
