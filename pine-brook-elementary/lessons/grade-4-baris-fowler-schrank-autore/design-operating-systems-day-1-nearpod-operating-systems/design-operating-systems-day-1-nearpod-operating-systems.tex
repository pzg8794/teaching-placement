...
\item Reference file: design-operating-systems-day-1-nearpod-operating-systems.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: - I can define what an operating system is | - I can identify the most common operating systems | - I can explain the functions of an operating system
