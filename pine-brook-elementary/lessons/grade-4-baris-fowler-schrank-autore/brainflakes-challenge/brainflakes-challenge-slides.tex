...
\end{tikzpicture}
\end{center}
\note{Today we are working on brainflakes challenge}
\end{frame}
...
\Large -I can share information and collaboratively build a structure that represents my group's shared and unique qualities.
\end{block}
\begin{itemize}\large
\item -I can share information and collaboratively build a structure that represents my group's shared and unique qualities.
\item -I can demonstrate teamwork and problem-solving skills during a building challenge.
\item -I can apply computational thinking concepts such as decomposition and abstraction to design my Brain Flakes structure 4-6.CT.8 .4-6.CT.10).
\end{itemize}
\column{0.4\textwidth}
