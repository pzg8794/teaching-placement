...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Lego Spike: | Bowling Fun\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on lego spike: | bowling fun. Watch first, then try it with me.
