...
\end{tikzpicture}
\end{center}
\note{Today we are working on lego spike: | bowling}
\end{frame}
...
\Large - I can predict outcomes of the changes in energy that occur when objects collide.
\end{block}
\begin{itemize}\large
\item - I can predict outcomes of the changes in energy that occur when objects collide.
\item - I can observe and describe the relationship between energy and force.
\item - I can engage effectively in a range of collaborative discussions.
\end{itemize}
\column{0.4\textwidth}
