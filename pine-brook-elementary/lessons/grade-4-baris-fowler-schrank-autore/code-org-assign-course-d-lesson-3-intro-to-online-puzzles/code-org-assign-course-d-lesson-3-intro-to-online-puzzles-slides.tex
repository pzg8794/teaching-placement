...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Code.org- Assign Course D Lesson 3 Intro. to Online Puzzles\par}
\vspace{0.3cm}
...
\begin{itemize}
\item I can decompose a problem into smaller named parts
\item I can develop algorithms or programs that include repetition and conditionals for the purposes of debugging
\item I can model how data is structured to transmit through a network
\end{itemize}
...
\footnotesize
\begin{itemize}
\item Today we are working on code.org- assign course d lesson 3 intro. to online puzzles. Watch first, then try it with me.
