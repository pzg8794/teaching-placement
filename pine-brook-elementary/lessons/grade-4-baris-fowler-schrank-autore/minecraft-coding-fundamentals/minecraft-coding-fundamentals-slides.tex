...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Minecraft Coding Fundamentals\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on minecraft coding fundamentals. Watch first, then try it with me.
