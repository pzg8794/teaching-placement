...
\end{tikzpicture}
\end{center}
\note{Today we are working on minecraft coding fundamentals}
\end{frame}
...
\node[draw=mint!80!black, fill=mint!14, rounded corners=9pt, minimum width=3.45cm, minimum height=0.95cm, text width=3.1cm, align=center] at (2.4,0.95) {\scriptsize Grade 4};
\end{tikzpicture}
\end{columns}
\note{Today we are working on minecraft coding fundamentals}
\end{frame}
