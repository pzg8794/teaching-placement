...
{\huge\bfseries\color{ink} Minecraft Coding Fundamentals\par}
\vspace{0.2cm}
...
\normalsize Agent-based coding, debugging, and computational problem solving in Minecraft Education
\end{block}
\vspace{0.1cm}
\begin{itemize}
\normalsize
...
\begin{itemize}
\normalsize
\item Open with a short model that names the lesson focus: agent-based
