...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Tech Careers, Docs, \& Read Write\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on tech careers, docs, \& read write. Watch first, then try it with me.
