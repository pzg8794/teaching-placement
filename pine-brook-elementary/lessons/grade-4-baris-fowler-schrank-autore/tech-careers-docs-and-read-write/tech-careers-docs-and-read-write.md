...
- **Student slides (LaTeX):** [tech-careers-docs-and-read-write-slides.tex](./tech-careers-docs-and-read-write-slides.tex)
- **Student slides (PDF):** [tech-careers-docs-and-read-write-slides.pdf](./tech-careers-docs-and-read-write-slides.pdf)
...
- Today we are working on tech careers, docs, & read write. Watch first, then try it with me.
