...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Sphero Illuminating Events\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on sphero illuminating events. Watch first, then try it with me.
