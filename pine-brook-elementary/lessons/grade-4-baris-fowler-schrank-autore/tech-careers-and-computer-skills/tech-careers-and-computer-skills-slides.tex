...
\end{tikzpicture}
\end{center}
\note{Today we are working on tech careers \& computer}
\end{frame}
...
\Large - Summarize an article about a job involving computer science.
\end{block}
\begin{itemize}\large
\item - Summarize an article about a job involving computer science.
\item - Explore how to use Read \& Write for Google Chrome as a learning aid.
\item - Utilize a variety of Google Docs features to create, revise, and share your article summary.
\end{itemize}
\column{0.4\textwidth}
