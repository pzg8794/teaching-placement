...
{\huge\bfseries\color{ink} Tech Careers \& Computer Skills\par}
\vspace{0.2cm}
...
\end{center}
\end{columns}
\note{Audience guidance: Intermediate learners who can handle complex digital tasks when setup friction, debugging, and persistence are explicitly. Teaching move: Anchor the abstract idea in a concrete example from school or home technology use.}
\end{frame}
