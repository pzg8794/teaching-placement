...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Google Slides Monopoly\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on google slides monopoly. Watch first, then try it with me.
