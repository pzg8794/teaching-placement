...
\vspace{0.5cm}
\begin{center}
{\Huge\bfseries\color{ink} Google Slides Monopoly\par}
\vspace{0.18cm}
...
\Large - I can use Google Slides to create a digital artifact
\end{block}
\begin{itemize}\large
\item - I can use Google Slides to create a digital artifact
\item - I can explain the purpose of cryptography
