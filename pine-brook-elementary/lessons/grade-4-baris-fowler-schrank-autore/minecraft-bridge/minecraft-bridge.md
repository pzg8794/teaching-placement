...
- **LaTeX source:** [minecraft-bridge.tex](./minecraft-bridge.tex)
- **Bib file:** [minecraft-bridge.bib](./minecraft-bridge.bib)
- **Audience profile:** [class-audience-profile.md](../class-audience-profile.md)
- **Student slides (LaTeX):** [minecraft-bridge-slides.tex](./minecraft-bridge-slides.tex)
- **Student slides (PDF):** [minecraft-bridge-slides.pdf](./minecraft-bridge-slides.pdf)
...
- Today we are working on minecraft: bridge. Watch first, then try it with me.
