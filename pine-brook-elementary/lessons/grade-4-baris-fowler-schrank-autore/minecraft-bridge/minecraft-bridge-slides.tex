...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Minecraft: Bridge\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on minecraft: bridge. Watch first, then try it with me.
