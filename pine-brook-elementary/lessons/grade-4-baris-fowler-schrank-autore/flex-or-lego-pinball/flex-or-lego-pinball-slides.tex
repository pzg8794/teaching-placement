...
{\huge\bfseries\color{ink} FLEX or Lego Pinball\par}
\vspace{0.2cm}
...
\end{center}
\end{columns}
\note{Audience guidance: Intermediate learners who can handle complex digital tasks when setup friction, debugging, and persistence are explicitly. Teaching move: Make the challenge criteria visible from the first slide through cleanup.}
\end{frame}
