\documentclass[11pt]{article}
    ...
    \item Reference file: ai-as-a-thought-partner-ai-playground.bib
    \end{itemize}
    \section*{School Planning Goals and Inclusion}
    \begin{itemize}[leftmargin=*]
    \item What is expected: - I can understand the concept of AI as a thought partner. | - I can explore creative uses of AI in brainstorming and problem-solving. | - I can develop critical thinking skills and evaluate AI-generated output. | - I can describe ways I will use AI as a tool for learning.
