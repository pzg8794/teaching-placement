...
\end{tikzpicture}
\end{center}
\note{Today we are working on magic school | 1st}
\end{frame}
...
\Large - I can explain what MagicSchool is and why it's useful for learning.
\end{block}
\begin{itemize}\large
\item - I can explain what MagicSchool is and why it's useful for learning.
\item - I can log into MagicSchool and find my way around the main areas.
\item - I can name at least three different types of activities available on MagicSchool.
\end{itemize}
\column{0.4\textwidth}
