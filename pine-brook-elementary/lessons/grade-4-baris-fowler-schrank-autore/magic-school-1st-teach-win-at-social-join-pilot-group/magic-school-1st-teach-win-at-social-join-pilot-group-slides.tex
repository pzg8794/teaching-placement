...
\title{Magic School | ***1st Teach WIN At Social (Join Pilot Group)}
...
{\huge\bfseries\color{ink} Magic School | ***1st Teach WIN At Social (Join Pilot Group)\par}
\vspace{0.2cm}
...
\end{center}
\end{columns}
\note{Audience guidance: Intermediate learners who can handle complex digital tasks when setup friction, debugging, and persistence are explicitly. Teaching move: Model the first screen and the exact tool students must use before release.}
\end{frame}
