...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Event-Driven Robot Coding\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on event-driven robot coding. Watch first, then try it with me.
