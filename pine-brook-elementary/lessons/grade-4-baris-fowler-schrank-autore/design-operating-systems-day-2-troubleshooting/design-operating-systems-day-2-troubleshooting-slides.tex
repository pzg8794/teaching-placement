...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Design Operating Systems | Day 2: Troubleshooting\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on design operating systems | day 2: troubleshooting. Watch first, then try it with me.
