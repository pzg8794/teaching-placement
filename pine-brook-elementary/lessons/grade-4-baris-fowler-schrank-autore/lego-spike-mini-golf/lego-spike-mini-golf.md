...
- **Workbook sessions:** `Session 24`
- **Months:** March
- **Class blocks:** Day 1 `1:15-2:10` Baris, Day 2 `1:15-2:10` Fowler, Day 3 `1:15-2:10` Schrank, Day 4 `1:15-2:10` Autore
- **LaTeX source:** [lego-spike-mini-golf.tex](./lego-spike-mini-golf.tex)
- **Bib file:** [lego-spike-mini-golf.bib](./lego-spike-mini-golf.bib)
...
- **Student slides (LaTeX):** [lego-spike-mini-golf-slides.tex](./lego-spike-mini-golf-slides.tex)
- **Student slides (PDF):** [lego-spike-mini-golf-slides.pdf](./lego-spike-mini-golf-slides.pdf)
...
- Today we are working on lego spike: | mini golf. Watch first, then try it with me.
