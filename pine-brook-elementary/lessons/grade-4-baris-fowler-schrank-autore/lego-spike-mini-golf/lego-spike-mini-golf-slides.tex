...
\end{tikzpicture}
\end{center}
\note{Today we are working on lego spike: | mini}
\end{frame}
...
\Large - I can explore the basic principles of energy and their connection to an object's speed.
\end{block}
\begin{itemize}\large
\item - I can explore the basic principles of energy and their connection to an object's speed.
\item - I can identify and describe the relationship between speed and energy.
\item - Use data to highlight or propose cause-and-effect relationships, predict outcomes, or communicate an idea.
\end{itemize}
\column{0.4\textwidth}
