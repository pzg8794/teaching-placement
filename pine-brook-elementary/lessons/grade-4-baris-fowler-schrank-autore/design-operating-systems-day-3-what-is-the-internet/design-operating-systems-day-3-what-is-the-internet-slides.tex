...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Design Operating Systems | Day 3: What is the Internet\par}
\vspace{0.3cm}
...
\begin{itemize}
\item I can explain how the internet works
\item I can explain how the internet has changed the world
\end{itemize}
...
\footnotesize
\begin{itemize}
\item Today we are working on design operating systems | day 3: what is the internet. Watch first, then try it with me.
