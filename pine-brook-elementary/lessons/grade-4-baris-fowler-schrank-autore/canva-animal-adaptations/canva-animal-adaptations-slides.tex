...
\vspace{0.5cm}
\begin{center}
{\Huge\bfseries\color{ink} Canva Animal Adaptations\par}
\vspace{0.18cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on canva animal adaptations}
\end{frame}
...
\Large - I can type on a keyboard while demonstrating proper keyboarding technique
\end{block}
\begin{itemize}\large
\item - I can type on a keyboard while demonstrating proper keyboarding technique
\item - I can select appropriate digital tools to communicate and collaborate with others
\item - I can locate relevant information when searching online by refining my search terms
\end{itemize}
\column{0.4\textwidth}
