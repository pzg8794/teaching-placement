...
\end{tikzpicture}
\end{center}
\note{Today we are working on adding persuasive content}
\end{frame}
...
\Large I can write persuasive sentences to explain my opinion.
\end{block}
\begin{itemize}\large
\item I can write persuasive sentences to explain my opinion.
\item I can add pictures or videos to my site.
