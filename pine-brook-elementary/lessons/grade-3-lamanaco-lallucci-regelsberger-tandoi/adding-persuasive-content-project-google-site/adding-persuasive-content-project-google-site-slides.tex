...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Adding Persuasive Content (Project Google Site)\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on adding persuasive content (project google site). Watch first, then try it with me.
