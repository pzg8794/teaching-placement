...
\end{tikzpicture}
\end{center}
\note{Today we are working on code your own sports}
\end{frame}
...
\Large I can find and fix errors in my algorithm
\end{block}
\begin{itemize}\large
\item I can find and fix errors in my algorithm
\item I can make a game that does something (output) based on what I tell it to do (input)
