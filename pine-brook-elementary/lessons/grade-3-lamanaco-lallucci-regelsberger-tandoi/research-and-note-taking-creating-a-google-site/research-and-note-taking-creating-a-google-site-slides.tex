...
\title{Research \& Note-Taking(Creating a Google Site)}
...
\vspace{0.55cm}
\begin{center}
{\Huge\bfseries\color{ink} Research \& Note-Taking(Creating a Google Site)\par}
\vspace{0.15cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on research \& note-taking}
\end{frame}
...
\Large I can find facts about wolves in Yellowstone.
\end{block}
\begin{itemize}\large
\item I can find facts about wolves in Yellowstone.
\item I can take notes on reasons why wolves are good or bad for the environment.
\item I can edit a homepage text, and add sections.
\end{itemize}
\column{0.4\textwidth}
