...
\item Reference file: research-and-note-taking-creating-a-google-site.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: I can find facts about wolves in Yellowstone. | | I can take notes on reasons why wolves are good or bad for the environment. | | I can edit a homepage text, and add sections.
