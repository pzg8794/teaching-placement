...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Sphero: Maze Navigation\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on sphero: maze navigation. Watch first, then try it with me.
