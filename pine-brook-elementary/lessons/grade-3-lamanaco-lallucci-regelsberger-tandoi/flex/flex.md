...
- **Workbook sessions:** `Session 7, Session 25`
...
- **LaTeX source:** [flex.tex](./flex.tex)
- **Bib file:** [flex.bib](./flex.bib)
- **Learning targets:** Not listed
- **Special education considerations:** No grade-sheet note captured for this lesson.
- **Cross-curricular context:** 3 - ARC / Sci: Dinosaurs and Knights (Literacy Lab) | 6-8 weeks | 3 - Science: Invisible Forces (September - October) | 3 - Math: Multiplication and Divsion: Concepts, Relationships, and Patterns | (Oct 10 - Dec 22); 3 - ARC / Sci: Traditional Tales and World Culture (Narrative) | 9 Weeks | 3 - Science: Where Are the Wolves (March- End of the Year) | 3 - Math: Measurement: Time, Liquid Volume, and Mass | (Mar 25 - May 3)
- **Audience profile:** [class-audience-profile.md](../class-audience-profile.md)
- **Student slides (LaTeX):** [flex-slides.tex](./flex-slides.tex)
- **Student slides (PDF):** [flex-slides.pdf](./flex-slides.pdf)
...
- Today we are working on flex. Watch first, then try it with me.
