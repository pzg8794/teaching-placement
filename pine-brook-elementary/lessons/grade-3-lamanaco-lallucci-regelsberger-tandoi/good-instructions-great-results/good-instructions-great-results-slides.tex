...
\end{tikzpicture}
\end{center}
\note{Today we are working on good instructions- great results!}
\end{frame}
...
\Large I can create a model of an object and then identify the patterns and essential elements of it.
\end{block}
\begin{itemize}\large
\item I can create a model of an object and then identify the patterns and essential elements of it.
