...
\item Reference file: squishy-circuits-projects.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: I can define the basic components of a simple circuit | I can understand the difference between conductive and insulating materials | I can construct a simple circuit project using squishy dough to light an LED. | I can troubleshoot simple circuit problems
