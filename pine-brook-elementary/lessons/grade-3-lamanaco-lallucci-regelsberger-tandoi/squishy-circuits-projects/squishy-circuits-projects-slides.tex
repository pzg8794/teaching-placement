...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Squishy Circuits Projects\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on squishy circuits projects. Watch first, then try it with me.
