...
\end{tikzpicture}
\end{center}
\note{Today we are working on squishy circuits projects}
\end{frame}
...
\Large I can define the basic components of a simple circuit
\end{block}
\begin{itemize}\large
\item I can define the basic components of a simple circuit
\item I can understand the difference between conductive and insulating materials
\item I can construct a simple circuit project using squishy dough to light an LED.
\end{itemize}
\column{0.4\textwidth}
