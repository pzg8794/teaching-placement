\documentclass[11pt]{article}
    ...
    \item Reference file: clickbait-and-kryptonite.bib
    \end{itemize}
    \section*{School Planning Goals and Inclusion}
    \begin{itemize}[leftmargin=*]
    \item What is expected: I can explain what links or pop-ups (clickbait) that I should not click on in an app or online. | I can describe how to report any unusual behavior online to a trusted adult
