...
\end{tikzpicture}
\end{center}
\note{Today we are working on clickbait and kryptonite}
\end{frame}
...
\Large I can explain what links or pop-ups (clickbait) that I should not click on in an app or online.
\end{block}
\begin{itemize}\large
\item I can explain what links or pop-ups (clickbait) that I should not click on in an app or online.
\item I can describe how to report any unusual behavior online to a trusted adult
