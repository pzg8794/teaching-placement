...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Finalize and Present Project\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on finalize and present project. Watch first, then try it with me.
