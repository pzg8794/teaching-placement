...
\end{tikzpicture}
\end{center}
\note{Today we are working on finalize and present project}
\end{frame}
...
\Large I can check my Google Site to make sure it is correct and clear.
\end{block}
\begin{itemize}\large
\item I can check my Google Site to make sure it is correct and clear.
\item I can share and present my completed site.
