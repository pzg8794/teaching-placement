...
\end{tikzpicture}
\end{center}
\note{Today we are working on planning your site}
\end{frame}
...
\Large I can plan the pages of my Google Site.
\end{block}
\begin{itemize}\large
\item I can plan the pages of my Google Site.
\item I can organize my ideas for each page.
