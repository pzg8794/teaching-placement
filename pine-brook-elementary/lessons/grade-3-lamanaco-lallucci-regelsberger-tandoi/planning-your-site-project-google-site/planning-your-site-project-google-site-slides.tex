...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Planning Your Site (Project - Google Site)\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on planning your site (project - google site). Watch first, then try it with me.
