...
\end{tikzpicture}
\end{center}
\note{Today we are working on sculpting your first circuit}
\end{frame}
...
\Large I can build a simple circuit.
\end{block}
\begin{itemize}\large
\item I can build a simple circuit.
\item I can understand what a circuit is.
\item I can explain how a simple circuit works.
\end{itemize}
\column{0.4\textwidth}
