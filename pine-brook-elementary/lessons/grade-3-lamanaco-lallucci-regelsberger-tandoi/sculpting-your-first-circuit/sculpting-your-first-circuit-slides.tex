...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Sculpting Your First Circuit\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on sculpting your first circuit. Watch first, then try it with me.
