...
\item Reference file: sculpting-your-first-circuit.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: I can build a simple circuit. | I can understand what a circuit is. | I can explain how a simple circuit works.
