...
\end{tikzpicture}
\end{center}
\note{Today we are working on conductors vs}
\end{frame}
...
\Large I can define conductor and insulator.
\end{block}
\begin{itemize}\large
\item I can define conductor and insulator.
\item I can identify examples of conductors and insulators.
\item I can explain the difference between a conductor and an insulator in terms of electricity flow.
\end{itemize}
\column{0.4\textwidth}
