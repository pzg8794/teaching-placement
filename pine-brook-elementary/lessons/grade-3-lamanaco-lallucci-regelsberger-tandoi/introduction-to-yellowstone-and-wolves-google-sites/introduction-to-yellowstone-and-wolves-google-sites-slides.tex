...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Introduction to Yellowstone \& Wolves (Google Sites)\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on introduction to yellowstone \& wolves (google sites). Watch first, then try it with me.
