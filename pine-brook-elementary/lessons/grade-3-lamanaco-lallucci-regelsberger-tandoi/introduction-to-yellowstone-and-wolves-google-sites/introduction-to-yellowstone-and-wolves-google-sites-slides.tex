...
\vspace{0.55cm}
\begin{center}
{\Huge\bfseries\color{ink} Introduction to Yellowstone \& Wolves (Google Sites)\par}
\vspace{0.15cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on introduction to yellowstone \&}
\end{frame}
...
\Large I can explain what Yellowstone National Park is and why wolves are important there.
\end{block}
\begin{itemize}\large
\item I can explain what Yellowstone National Park is and why wolves are important there.
