...
\end{tikzpicture}
\end{center}
\note{Today we are working on lunchtime data}
\end{frame}
...
\Large I can collect information from several resources to determine the different ways data can be collected.
\end{block}
\begin{itemize}\large
\item I can collect information from several resources to determine the different ways data can be collected.
