...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Responsible AI and Canva Publishing\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on responsible ai and canva publishing. Watch first, then try it with me.
