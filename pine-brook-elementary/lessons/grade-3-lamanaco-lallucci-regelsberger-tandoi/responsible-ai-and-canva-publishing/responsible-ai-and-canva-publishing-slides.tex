...
{\huge\bfseries\color{ink} Responsible AI and Canva Publishing\par}
\vspace{0.2cm}
...
\end{center}
\end{columns}
\note{Audience guidance: Upper-primary learners who can sustain design and robotics challenges when the structure supports collaboration and debugging.. Teaching move: Model the first screen and the exact tool students must use before release.}
\end{frame}
...
\normalsize AI literacy, responsible use, and digital publishing choices
\end{block}
\vspace{0.1cm}
\begin{itemize}
\large
...
\begin{itemize}
\large
\item Open with a short model that names the lesson focus: AI
