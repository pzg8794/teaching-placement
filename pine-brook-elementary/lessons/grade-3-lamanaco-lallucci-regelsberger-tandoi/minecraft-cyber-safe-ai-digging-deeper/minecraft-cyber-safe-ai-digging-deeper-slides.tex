...
\title{Minecraft Cyber Safe: AI Digging Deeper}
...
\vspace{0.55cm}
\begin{center}
{\Huge\bfseries\color{ink} Minecraft Cyber Safe: AI Digging Deeper\par}
\vspace{0.15cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on minecraft cyber safe: ai}
\end{frame}
...
\Large I can identify how computing technologies, such as AI have changed the way people live and work (2-3.IC.1)
\end{block}
\begin{itemize}\large
\item I can identify how computing technologies, such as AI have changed the way people live and work (2-3.IC.1)
\item I can recognize that the rules around computing devices can change in different settings, for example from IGNITE to the classroom (2-3.IC.2)
\item I understand why information should be kept private (2-3.CY.1) and know ways to keep my personal information safe (2-3.CY.2)
\end{itemize}
\column{0.4\textwidth}
...
\node[draw=tealpop!80!black, fill=tealpop!14, rounded corners=10pt, minimum width=3.4cm, minimum height=0.9cm, text width=3.0cm, align=center] at (2.3,0.95) {\scriptsize Day 3 `9:50-10:40` Lamanaco, Day 4 `9:50-10:40` Lallucci, Day 5 `9:50-10:40` Regelsberger, Day 5 `2:15-3:05` Tandoi};
\end{tikzpicture}
\end{columns}
\note{Today we are working on minecraft cyber safe: ai}
\end{frame}
...
\node[rounded corners=14pt, fill=berrypop!14, draw=berrypop!85, minimum width=3.1cm, minimum height=2.0cm, text width=2.4cm, align=center] (s1) {\Large\bfseries STEP 1\\[4pt]Project the exact click path before students};
\node[rounded corners=14pt, fill=goldpop!18, draw=goldpop!80!black, minimum width=3.1cm, minimum height=2.0cm, text width=2.4cm, align=center, right=of s1] (s2) {\Large\bfseries STEP 2\\[4pt]Use a stop-and-check slide after world entry};
\node[rounded corners=14pt, fill=tealpop!16, draw=tealpop!80!black, minimum width=3.1cm, minimum height=2.0cm, text width=2.4cm, align=center, right=of s2] (s3) {\Large\bfseries STEP 3\\[4pt]Require test-after-each-change routines so debugging stays visible};
...
\foreach \y/\txt/\col in {3.85/Sign-in or menu navigation can block learning before coding even starts/berrypop,2.7/Directions can feel hidden/goldpop,1.55/Students may not know they are done/tealpop} {
