...
\end{tikzpicture}
\end{center}
\note{Today we are working on ai for oceans}
\end{frame}
...
\Large I can use a computer to label images and help train an AI model to recognize fish and trash.
\end{block}
\begin{itemize}\large
\item I can use a computer to label images and help train an AI model to recognize fish and trash.
\item I can explain how the examples I provide affect the AI’s ability to learn and make decisions.
\item I can recognize that bias in data can cause mistakes in AI’s classifications.
\end{itemize}
\column{0.4\textwidth}
