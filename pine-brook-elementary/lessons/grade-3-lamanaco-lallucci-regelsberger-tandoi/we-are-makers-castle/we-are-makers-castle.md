...
- **Workbook sessions:** `Session 5, Session 6`
- **Months:** October
- **Class blocks:** Day 3 `9:50-10:40` Lamanaco, Day 4 `9:50-10:40` Lallucci, Day 5 `9:50-10:40` Regelsberger, Day 5 `2:15-3:05` Tandoi
- **LaTeX source:** [we-are-makers-castle.tex](./we-are-makers-castle.tex)
- **Bib file:** [we-are-makers-castle.bib](./we-are-makers-castle.bib)
...
- **Student slides (LaTeX):** [we-are-makers-castle-slides.tex](./we-are-makers-castle-slides.tex)
- **Student slides (PDF):** [we-are-makers-castle-slides.pdf](./we-are-makers-castle-slides.pdf)
...
- Today we are working on we are makers: castle. Watch first, then try it with me.
