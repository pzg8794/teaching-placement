...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Moving Sphero (Farm Bots)\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on moving sphero (farm bots). Watch first, then try it with me.
