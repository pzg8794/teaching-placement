...
- **Student slides (LaTeX):** [moving-sphero-farm-bots-slides.tex](./moving-sphero-farm-bots-slides.tex)
- **Student slides (PDF):** [moving-sphero-farm-bots-slides.pdf](./moving-sphero-farm-bots-slides.pdf)
...
- Today we are working on moving sphero (farm bots). Watch first, then try it with me.
