\documentclass[11pt]{article}
    ...
    \item Reference file: minecraft-cyber-security-home-sweet-hmmm.bib
    \end{itemize}
    \section*{School Planning Goals and Inclusion}
    \begin{itemize}[leftmargin=*]
    \item What is expected: I understand why information should be kept private (2-3.CY.1) and know ways to keep my personal information safe (2-3.CY.2) | I understand what it means to be part of a digital community and how to keep it a safe and respectful place
