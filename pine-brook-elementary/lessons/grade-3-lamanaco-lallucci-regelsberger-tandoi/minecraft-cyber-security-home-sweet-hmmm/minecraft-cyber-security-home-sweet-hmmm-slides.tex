...
\end{center}
\end{columns}
\note{Audience guidance: Upper-primary learners who can sustain design and robotics challenges when the structure supports collaboration and debugging.. Teaching move: Project the exact click path before students begin so setup friction does not consume}
\end{frame}
