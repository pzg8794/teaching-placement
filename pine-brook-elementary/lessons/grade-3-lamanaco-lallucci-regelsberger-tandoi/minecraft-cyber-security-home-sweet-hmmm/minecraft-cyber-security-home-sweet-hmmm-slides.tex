...
\title{MineCraft: Cyber Security Home Sweet Hmmm}
...
\vspace{0.55cm}
\begin{center}
{\Huge\bfseries\color{ink} MineCraft: Cyber Security Home Sweet Hmmm\par}
\vspace{0.15cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on minecraft: cyber security home}
\end{frame}
...
\Large I understand why information should be kept private (2-3.CY.1) and know ways to keep my personal information safe (2-3.CY.2)
\end{block}
\begin{itemize}\large
...
\item I understand what it means to be part of a digital community and how to keep it a safe and respectful place
