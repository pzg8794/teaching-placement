...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge MineCraft: Cyber Security Home Sweet Hmmm\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on minecraft: cyber security home sweet hmmm. Watch first, then try it with me.
