...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Code a Square (Farming Bots)\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on code a square (farming bots). Watch first, then try it with me.
