...
{\huge\bfseries\color{ink} Dream Treehouse\par}
\vspace{0.2cm}
...
\end{center}
\end{columns}
\note{Audience guidance: Upper-primary learners who can sustain design and robotics challenges when the structure supports collaboration and debugging.. Teaching move: Make the challenge criteria visible from the first slide through cleanup.}
\end{frame}
