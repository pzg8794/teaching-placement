...
\end{tikzpicture}
\end{center}
\note{Today we are working on dream treehouse}
\end{frame}
...
\Large I can rethink my ideas and improve my design (2-3.CT.9)
\end{block}
\begin{itemize}\large
\item I can rethink my ideas and improve my design (2-3.CT.9)
\item I can outline specific steps to create my treehouse (2-3.CT.10)
\item I can think crictically and break down the steps for building a treehouse into multiple different solutions (2-3.CT.4)
\end{itemize}
\column{0.4\textwidth}
