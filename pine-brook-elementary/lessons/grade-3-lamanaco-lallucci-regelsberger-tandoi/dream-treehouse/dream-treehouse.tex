...
\item Grade: Grade 3
\item Workbook sessions: Session 3, Session 4
...
\item Reference file: dream-treehouse.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: I can rethink my ideas and improve my design (2-3.CT.9) | I can outline specific steps to create my treehouse (2-3.CT.10) | I can think crictically and break down the steps for building a treehouse into multiple different solutions (2-3.CT.4)
