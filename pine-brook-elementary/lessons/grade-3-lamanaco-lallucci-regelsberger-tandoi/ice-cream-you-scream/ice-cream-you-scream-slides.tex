...
\end{tikzpicture}
\end{center}
\note{Today we are working on ice cream you scream}
\end{frame}
...
\Large I can develop a survey to collect data.
\end{block}
\begin{itemize}\large
\item I can develop a survey to collect data.
\item I can organize and record data accurately.
\item I can create different types of graphs or charts to represent data.
\end{itemize}
\column{0.4\textwidth}
