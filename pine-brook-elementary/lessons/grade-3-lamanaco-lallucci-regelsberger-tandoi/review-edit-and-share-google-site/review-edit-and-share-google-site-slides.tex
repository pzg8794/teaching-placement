...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Review, Edit, and Share (Google Site)\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on review, edit, and share (google site). Watch first, then try it with me.
