...
\title{Review, Edit, and Share (Google Site)}
...
\vspace{0.55cm}
\begin{center}
{\Huge\bfseries\color{ink} Review, Edit, and Share (Google Site)\par}
\vspace{0.15cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on review, edit, and share}
\end{frame}
...
\Large I can check my work for mistakes and fix them.
\end{block}
\begin{itemize}\large
\item I can check my work for mistakes and fix them.
\item I can publish and share my Google Site safely.
