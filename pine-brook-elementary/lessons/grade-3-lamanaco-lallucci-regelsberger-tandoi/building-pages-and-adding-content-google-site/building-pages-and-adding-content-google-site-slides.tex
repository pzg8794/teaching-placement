...
\title{Building Pages and Adding Content (Google Site)}
...
\vspace{0.55cm}
\begin{center}
{\Huge\bfseries\color{ink} Building Pages and Adding Content (Google Site)\par}
\vspace{0.15cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on building pages and adding}
\end{frame}
...
\Large I can add new pages to my Google Site.
\end{block}
\begin{itemize}\large
\item I can add new pages to my Google Site.
\item I can write facts and add pictures about wolves on my site.
