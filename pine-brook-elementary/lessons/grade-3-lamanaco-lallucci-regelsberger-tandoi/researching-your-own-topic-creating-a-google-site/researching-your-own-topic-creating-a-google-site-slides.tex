...
\title{Researching Your Own Topic (Creating a Google Site)}
...
\vspace{0.55cm}
\begin{center}
{\Huge\bfseries\color{ink} Researching Your Own Topic (Creating a Google Site)\par}
\vspace{0.15cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on researching your own topic}
\end{frame}
...
\Large I can find facts that support my opinion.
\end{block}
\begin{itemize}\large
\item I can find facts that support my opinion.
\item I can write notes about my facts.
