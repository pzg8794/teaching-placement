...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Researching Your Own Topic (Creating a Google Site)\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on researching your own topic (creating a google site). Watch first, then try it with me.
