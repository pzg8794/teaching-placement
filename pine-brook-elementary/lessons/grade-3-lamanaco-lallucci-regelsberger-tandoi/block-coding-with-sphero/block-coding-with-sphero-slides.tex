...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Block Coding with Sphero\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on block coding with sphero. Watch first, then try it with me.
