...
\end{tikzpicture}
\end{center}
\note{Today we are working on student-chosen environmental topic}
\end{frame}
...
\Large I can choose an environmental topic I care about.
\end{block}
\begin{itemize}\large
\item I can choose an environmental topic I care about.
\item I can say if my topic is good or bad for the environment.
\item I can start a Google Site and create a homepage.
\end{itemize}
\column{0.4\textwidth}
