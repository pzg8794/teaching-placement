...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Student-Chosen Environmental Topic (Project - Creating a Google Site)\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on student-chosen environmental topic (project - creating a google site). Watch first, then try it with me.
