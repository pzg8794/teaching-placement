...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge MineCraft: Cyber Safe Good Game\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on minecraft: cyber safe good game. Watch first, then try it with me.
