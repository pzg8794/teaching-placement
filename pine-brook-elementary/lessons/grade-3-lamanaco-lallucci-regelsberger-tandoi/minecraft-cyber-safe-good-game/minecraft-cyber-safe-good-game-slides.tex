...
\vspace{0.55cm}
\begin{center}
{\Huge\bfseries\color{ink} MineCraft: Cyber Safe Good Game\par}
\vspace{0.15cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on minecraft: cyber safe good}
\end{frame}
...
\Large I can identify public and private places online
\end{block}
\begin{itemize}\large
\item I can identify public and private places online
\item I can recognize and avoid harmful behaviors online
\item I can recognize suspicious online activities and seek help.
\end{itemize}
\column{0.4\textwidth}
