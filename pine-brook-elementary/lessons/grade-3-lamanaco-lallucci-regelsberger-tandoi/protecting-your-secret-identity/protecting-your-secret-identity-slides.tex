...
\end{tikzpicture}
\end{center}
\note{Today we are working on protecting your secret identity}
\end{frame}
...
\Large I can compare and contrast behaviors that do and do not keep information secure.
\end{block}
\begin{itemize}\large
\item I can compare and contrast behaviors that do and do not keep information secure.
