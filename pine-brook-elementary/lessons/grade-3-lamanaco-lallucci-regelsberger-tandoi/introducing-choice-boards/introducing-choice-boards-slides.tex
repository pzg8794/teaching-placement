...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Introducing Choice Boards\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on introducing choice boards. Watch first, then try it with me.
