...
\end{tikzpicture}
\end{center}
\note{Today we are working on fire drill escape}
\end{frame}
...
\Large I can create multiple solutions for a problem.
\end{block}
\begin{itemize}\large
\item I can create multiple solutions for a problem.
\item I can identify multiple ways that the same problem could be decomposed into smaller steps.
