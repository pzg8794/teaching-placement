...
\item Reference file: fire-drill-escape.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: I can create multiple solutions for a problem. | I can identify multiple ways that the same problem could be decomposed into smaller steps.
