...
\title{Persuasive Language \& Design (Google Site)}
...
\vspace{0.55cm}
\begin{center}
{\Huge\bfseries\color{ink} Persuasive Language \& Design (Google Site)\par}
\vspace{0.15cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on persuasive language \& design}
\end{frame}
...
\Large I can use persuasive words to share my opinion about wolves.
\end{block}
\begin{itemize}\large
\item I can use persuasive words to share my opinion about wolves.
\item I can make my Google Site look neat and easy to read.
