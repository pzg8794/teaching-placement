...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Business Plan Day 5: Tinkercad Building Desing\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on business plan day 5: tinkercad building desing. Watch first, then try it with me.
