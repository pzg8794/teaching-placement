...
\vspace{0.5cm}
\begin{center}
{\Huge\bfseries\color{ink} Current Events in Computing Technology (Creating an Infographic in Canva) Day 2\par}
\vspace{0.18cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on current events in computing}
\end{frame}
...
\Large I can explain current events that involve computing devices
\end{block}
\begin{itemize}\large
...
\node[rounded corners=14pt, fill=neonblue!12, draw=neonblue!80, minimum width=3.05cm, minimum height=2.0cm, text width=2.3cm, align=center] (s1) {\Large\bfseries 1\\[4pt]Model the first screen and the exact};
\node[rounded corners=14pt, fill=mango!17, draw=mango!80!black, minimum width=3.05cm, minimum height=2.0cm, text width=2.3cm, align=center, right=of s1] (s2) {\Large\bfseries 2\\[4pt]Use sentence frames or model examples when};
...
\foreach \y/\txt/\col in {3.9/Tool navigation can overshadow the content goal if too many options/neonblue,2.65/Directions can feel hidden/mango,1.4/Students may not know they are done/mint} {
