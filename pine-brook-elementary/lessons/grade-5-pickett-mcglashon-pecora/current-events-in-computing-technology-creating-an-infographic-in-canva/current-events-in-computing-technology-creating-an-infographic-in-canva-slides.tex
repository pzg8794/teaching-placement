...
\end{center}
\end{columns}
\note{Audience guidance: Older elementary learners who can manage autonomy and longer projects when expectations, accountability, and revision structures. Teaching move: Model the first screen and the exact tool students must use before release.}
\end{frame}
