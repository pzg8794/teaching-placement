...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge FLEX or | Keva Coaster Design, Day 2\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on flex or | keva coaster design, day 2. Watch first, then try it with me.
