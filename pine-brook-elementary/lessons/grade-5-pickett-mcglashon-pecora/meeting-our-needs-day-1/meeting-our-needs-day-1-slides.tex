...
\end{tikzpicture}
\end{center}
\note{Today we are working on meeting our needs, day}
\end{frame}
...
\Large I can create a model of a system (4-6.CT.1)
\end{block}
\begin{itemize}\large
\item I can create a model of a system (4-6.CT.1)
\item I can describe the steps I used and choices I made to design and devleop a solution using the design process (4-6.CT.10)
