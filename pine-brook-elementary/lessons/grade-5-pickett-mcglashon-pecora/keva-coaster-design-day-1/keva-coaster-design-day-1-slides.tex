...
\end{tikzpicture}
\end{center}
\note{Today we are working on keva coaster design, day}
\end{frame}
...
\Large I can compare two or more algorithms and discuss the advantages and disadvantages of each (4-6.CT.6)
\end{block}
\begin{itemize}\large
\item I can compare two or more algorithms and discuss the advantages and disadvantages of each (4-6.CT.6)
\item We can identify what pieces we had to change as we were building to make the roller coaster work (4-6.CT.7)
\item Develop algorithms or programs that use repetition and conditionals for creative expression (4-6.CT.8)
\end{itemize}
\column{0.4\textwidth}
