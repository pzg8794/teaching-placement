...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Tinkercad Design and Revision\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on tinkercad design and revision. Watch first, then try it with me.
