...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Flex or | Extra Day of Code.org | or STEM Wheel\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on flex or | extra day of code.org | or stem wheel. Watch first, then try it with me.
