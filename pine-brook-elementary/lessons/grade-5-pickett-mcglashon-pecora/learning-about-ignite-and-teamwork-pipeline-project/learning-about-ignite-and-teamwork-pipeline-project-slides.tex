...
\end{tikzpicture}
\end{center}
\note{Today we are working on learning about ignite \&}
\end{frame}
...
\Large - I can collaborate with classmates to solve problems and explain the steps we took to meet our goal.
\end{block}
\begin{itemize}\large
\item - I can collaborate with classmates to solve problems and explain the steps we took to meet our goal.
\item - I can discuss and reflect on how my group worked together.
\item - I can identify the Leadership and Computer Science standards we worked on today.
\end{itemize}
\column{0.4\textwidth}
