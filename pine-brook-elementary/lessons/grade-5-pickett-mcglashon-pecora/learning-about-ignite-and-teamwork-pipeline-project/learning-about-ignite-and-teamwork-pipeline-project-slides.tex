...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Learning About IGNITE \& Teamwork: Pipeline Project\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on learning about ignite \& teamwork: pipeline project. Watch first, then try it with me.
