# 🔴 Current Events in Computing Technology
...
- **LaTeX source:** [current-events-in-computing-technology.tex](./current-events-in-computing-technology.tex)
- **Bib file:** [current-events-in-computing-technology.bib](./current-events-in-computing-technology.bib)
...
- **Student slides (LaTeX):** [current-events-in-computing-technology-slides.tex](./current-events-in-computing-technology-slides.tex)
- **Student slides (PDF):** [current-events-in-computing-technology-slides.pdf](./current-events-in-computing-technology-slides.pdf)
...
- Today we are working on current events in computing technology. Watch first, then try it with me.
