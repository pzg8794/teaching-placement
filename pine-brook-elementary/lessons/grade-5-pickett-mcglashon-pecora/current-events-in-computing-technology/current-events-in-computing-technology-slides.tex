...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Current Events in Computing Technology\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on current events in computing technology. Watch first, then try it with me.
