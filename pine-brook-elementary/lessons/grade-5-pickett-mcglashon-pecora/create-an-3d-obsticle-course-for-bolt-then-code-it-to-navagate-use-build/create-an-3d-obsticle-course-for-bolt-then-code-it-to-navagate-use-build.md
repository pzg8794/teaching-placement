# 🔴 Create an 3D obsticle course for Bolt + then code it to navagate. Use Building Tools in Room?
...
- **LaTeX source:** [create-an-3d-obsticle-course-for-bolt-then-code-it-to-navagate-use-build.tex](./create-an-3d-obsticle-course-for-bolt-then-code-it-to-navagate-use-build.tex)
- **Bib file:** [create-an-3d-obsticle-course-for-bolt-then-code-it-to-navagate-use-build.bib](./create-an-3d-obsticle-course-for-bolt-then-code-it-to-navagate-use-build.bib)
- **Audience profile:** [class-audience-profile.md](../class-audience-profile.md)
- **Student slides (LaTeX):** [create-an-3d-obsticle-course-for-bolt-then-code-it-to-navagate-use-build-slides.tex](./create-an-3d-obsticle-course-for-bolt-then-code-it-to-navagate-use-build-slides.tex)
- **Student slides (PDF):** [create-an-3d-obsticle-course-for-bolt-then-code-it-to-navagate-use-build-slides.pdf](./create-an-3d-obsticle-course-for-bolt-then-code-it-to-navagate-use-build-slides.pdf)

## 🎯 School Planning Goals + Inclusion

- **What is expected:** Use the workbook expectation or transcript evidence in this folder as the baseline.
...
- Today we are working on create an 3d obsticle course for bolt + then code it to navagate. use building tools in room?. Watch first, then try it with me.
