...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Create an 3D obsticle course for Bolt + then code it to navagate. Use Building Tools in Room?\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on create an 3d obsticle course for bolt + then code it to navagate. use building tools in room?. Watch first, then try it with me.
