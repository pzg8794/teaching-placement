...
\end{tikzpicture}
\end{center}
\note{Today we are working on cyber security: bad guys}
\end{frame}
...
\Large I can explain what the difference is between private and public information.
\end{block}
\begin{itemize}\large
\item I can explain what the difference is between private and public information.
\item I can explain why different types of information need to be protected.
\item I can explain different online bad guys.
\end{itemize}
\column{0.4\textwidth}
