...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Presentation Day: | Students present their business to other peers in the classroom. Students give feedback (glows and grows) to their classmates.\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on presentation day: | students present their business to other peers in the classroom. students give feedback (glows and grows) to their classmates.. Watch first, then try it with me.
