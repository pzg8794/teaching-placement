...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Lego Spike Protect the Environment\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on lego spike protect the environment. Watch first, then try it with me.
