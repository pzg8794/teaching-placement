...
\end{tikzpicture}
\end{center}
\note{Today we are working on teach win it social}
\end{frame}
...
\Large I can explain Generative AI
\end{block}
\begin{itemize}\large
\item I can explain Generative AI
\item I can explain how to use AI responsibly and ethically for schoolwork
\item I can explain how Magic School AI will be used in class
\end{itemize}
\column{0.4\textwidth}
