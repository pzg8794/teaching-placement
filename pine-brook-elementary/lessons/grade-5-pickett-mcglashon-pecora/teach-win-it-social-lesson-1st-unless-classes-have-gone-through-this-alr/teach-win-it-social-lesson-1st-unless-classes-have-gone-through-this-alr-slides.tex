...
{\huge\bfseries\color{ink} Teach WIN it Social Lesson 1st (Unless classes have gone through this alreay with Librarian or Classroom Teacher)\par}
\vspace{0.2cm}
...
\normalsize Use code steps to make something happen on purpose.
\end{block}
\vspace{0.1cm}
\begin{itemize}
\normalsize
