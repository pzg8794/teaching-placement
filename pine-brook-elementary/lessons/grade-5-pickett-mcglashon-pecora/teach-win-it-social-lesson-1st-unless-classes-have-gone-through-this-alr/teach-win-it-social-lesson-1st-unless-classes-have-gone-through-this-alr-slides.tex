...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Teach WIN it Social Lesson 1st (Unless classes have gone through this alreay with Librarian or Classroom Teacher)\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on teach win it social lesson 1st (unless classes have gone through this alreay with librarian or classroom teacher). Watch first, then try it with me.
