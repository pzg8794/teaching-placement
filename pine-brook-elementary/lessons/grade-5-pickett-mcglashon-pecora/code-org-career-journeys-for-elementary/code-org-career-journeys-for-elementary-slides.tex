...
\end{tikzpicture}
\end{center}
\note{Today we are working on code}
\end{frame}
...
\Large I can identify information that I need to change as I create my program
\end{block}
\begin{itemize}\large
...
\node[rounded corners=14pt, fill=neonblue!12, draw=neonblue!80, minimum width=3.05cm, minimum height=2.0cm, text width=2.3cm, align=center] (s1) {\Large\bfseries 1\\[4pt]Anchor the abstract idea in a concrete};
\node[rounded corners=14pt, fill=mango!17, draw=mango!80!black, minimum width=3.05cm, minimum height=2.0cm, text width=2.3cm, align=center, right=of s1] (s2) {\Large\bfseries 2\\[4pt]Use one discussion prompt at a time};
...
\foreach \y/\txt/\col in {3.9/Too many examples at once can blur the core message/neonblue,2.65/Directions can feel hidden/mango,1.4/Students may not know they are done/mint} {
