...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Business Plan Day 2: | Business Proposals\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on business plan day 2: | business proposals. Watch first, then try it with me.
