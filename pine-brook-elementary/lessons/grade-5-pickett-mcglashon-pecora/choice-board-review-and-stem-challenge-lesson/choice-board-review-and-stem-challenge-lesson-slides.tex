...
\vspace{0.18cm}
{\Large\color{violet} Design, Debug, Present.\par}
\vspace{0.28cm}
\begin{tikzpicture}
...
{\Large\bfseries Upper elementary students can carry more independence when criteria, checkpoints, and troubleshooting are easy to re-find.};
\end{tikzpicture}
\vspace{0.32cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on choice board review \&}
\end{frame}
...
\item - I can describe the steps taken and choices made to design and develop a solution using the design process. (4-6.CT.10)
\end{itemize}
\column{0.4\textwidth}
\begin{tikzpicture}[x=1cm,y=1cm]
\draw[rounded corners=14pt, fill=white, draw=violet, line width=1.2pt] (0,0) rectangle (4.8,4.8);
\node[draw=neonblue!75, fill=neonblue!10, rounded corners=9pt, minimum width=3.45cm, minimum height=0.9cm] at (2.4,3.9) {\bfseries Grade 5};
\node[draw=mango!80!black, fill=mango!14, rounded corners=9pt, minimum width=3.45cm, minimum height=1.05cm, text width=3.1cm, align=center] at (2.4,2.35) {\small Older elementary learners who can manage autonomy and longer projects when expectations, accountability, and revision structures stay visible.};
\node[draw=mint!80!black, fill=mint!14, rounded corners=9pt, minimum width=3.45cm, minimum height=0.95cm, text width=3.1cm, align=center] at (2.4,0.95) {\scriptsize Day 2 `10:45-11:35` Pickett, Day 3 `10:45-11:35` McGlashon, Day 5 `10:45-11:35` Pecora};
\end{tikzpicture}
\end{columns}
\note{Today we are working on choice board review \&}
\end{frame}
...
\node[rounded corners=14pt, fill=neonblue!12, draw=neonblue!80, minimum width=3.05cm, minimum height=2.0cm, text width=2.3cm, align=center] (s1) {\Large\bfseries 1\\[4pt]Break the design process into plan, build,};
...
\foreach \y/\txt/\col in {3.9/Some groups need support organizing materials and sticking with one plan/neonblue,2.65/Explaining the design can be harder than making it without sentence/mango,1.4/Students may not know they are done/mint} {
