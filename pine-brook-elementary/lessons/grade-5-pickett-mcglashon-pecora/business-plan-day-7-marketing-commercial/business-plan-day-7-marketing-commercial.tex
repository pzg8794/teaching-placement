...
\item Reference file: business-plan-day-7-marketing-commercial.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: I can choose an appropriate digital tool to create a commercial (4-6.DL.2) | I can use a variety of digital tools and resources to market a business (4-6.DL.4)
