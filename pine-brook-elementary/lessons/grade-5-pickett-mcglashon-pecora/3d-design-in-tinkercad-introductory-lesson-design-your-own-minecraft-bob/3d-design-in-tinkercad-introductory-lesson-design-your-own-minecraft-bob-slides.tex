...
\end{center}
\end{columns}
\note{Audience guidance: Older elementary learners who can manage autonomy and longer projects when expectations, accountability, and revision structures. Teaching move: Project the exact click path before students begin so setup friction does not consume}
\end{frame}
