# 🔴 Recreate a Pattern Found in Tinkercad
...
- **LaTeX source:** [recreate-a-pattern-found-in-tinkercad.tex](./recreate-a-pattern-found-in-tinkercad.tex)
- **Bib file:** [recreate-a-pattern-found-in-tinkercad.bib](./recreate-a-pattern-found-in-tinkercad.bib)
- **Audience profile:** [class-audience-profile.md](../class-audience-profile.md)
- **Student slides (LaTeX):** [recreate-a-pattern-found-in-tinkercad-slides.tex](./recreate-a-pattern-found-in-tinkercad-slides.tex)
- **Student slides (PDF):** [recreate-a-pattern-found-in-tinkercad-slides.pdf](./recreate-a-pattern-found-in-tinkercad-slides.pdf)

## 🎯 School Planning Goals + Inclusion

- **What is expected:** I can document progress while following the computational thinking process: decomposition, pattern recognition, abstraction, and algorithm. (4-6.CT.4) | I can identify pieces of information that I might need to change as the program runs in order to get the result I am seeking. (4-6.CT.7) | I can create patterns by using the “Repeat” block and “Count with” block. (4-6.CT.8)
...
- Today we are working on recreate a pattern found in tinkercad. Watch first, then try it with me.
