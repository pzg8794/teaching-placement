...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Recreate a Pattern Found in Tinkercad\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on recreate a pattern found in tinkercad. Watch first, then try it with me.
