...
\item Reference file: meeting-our-needs-day-2.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: I can create a model of a system (4-6.CT.1) | I can describe the steps I used and choices I made to design and devleop a solution using the design process (4-6.CT.10)
