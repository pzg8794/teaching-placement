...
\end{tikzpicture}
\end{center}
\note{Today we are working on engineering based sphero lesson}
\end{frame}
...
\node[rounded corners=14pt, fill=neonblue!12, draw=neonblue!80, minimum width=3.05cm, minimum height=2.0cm, text width=2.3cm, align=center] (s1) {\Large\bfseries 1\\[4pt]Assign partner roles before materials come out};
\node[rounded corners=14pt, fill=mango!17, draw=mango!80!black, minimum width=3.05cm, minimum height=2.0cm, text width=2.3cm, align=center, right=of s1] (s2) {\Large\bfseries 2\\[4pt]Model one test-revise cycle with the actual};
\node[rounded corners=14pt, fill=mint!16, draw=mint!80!black, minimum width=3.05cm, minimum height=2.0cm, text width=2.3cm, align=center, right=of s2] (s3) {\Large\bfseries 3\\[4pt]Use a simple data language such as};
...
\foreach \y/\txt/\col in {3.9/Device-to-robot pairing and setup can split attention quickly/neonblue,2.65/One partner may take over unless roles are named and revisited/mango,1.4/Students may not know they are done/mint} {
