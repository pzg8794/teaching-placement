...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Engineering Based Sphero Lesson\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on engineering based sphero lesson. Watch first, then try it with me.
