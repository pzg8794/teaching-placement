...
\title{Don’t Go Phishing with the Enemy}
...
{\huge\bfseries\color{ink} Don’t Go Phishing with the Enemy\par}
\vspace{0.2cm}
...
\normalsize Notice a digital safety problem and make a smart choice.
\end{block}
\vspace{0.1cm}
\begin{itemize}
\normalsize
