...
- **Student slides (LaTeX):** [dont-go-phishing-with-the-enemy-slides.tex](./dont-go-phishing-with-the-enemy-slides.tex)
- **Student slides (PDF):** [dont-go-phishing-with-the-enemy-slides.pdf](./dont-go-phishing-with-the-enemy-slides.pdf)
...
- Today we are working on don’t go phishing with the enemy. Watch first, then try it with me.
