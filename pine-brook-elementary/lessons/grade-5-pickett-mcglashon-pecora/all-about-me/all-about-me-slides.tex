...
\end{tikzpicture}
\end{center}
\note{Today we are working on all about me}
\end{frame}
...
\Large Students will be able to create a presentation that reflects their interests, experiences, and goals for the next school year.
\end{block}
\begin{itemize}\large
\item Students will be able to create a presentation that reflects their interests, experiences, and goals for the next school year.
