...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Sending Messages with Light\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on sending messages with light. Watch first, then try it with me.
