...
\title{Google Slides - Intro Project, research carnivorous plants, model slide}
...
{\Huge\bfseries\color{ink} Google Slides - Intro Project, research carnivorous plants, model slide\par}
\vspace{0.2cm}
...
\end{center}
\end{columns}
\note{Audience guidance: Primary learners who can take on playful structure when directions stay concrete, visible, and socially supported.. Teaching move: Model the first screen and the exact tool students must use before release.}
\end{frame}
