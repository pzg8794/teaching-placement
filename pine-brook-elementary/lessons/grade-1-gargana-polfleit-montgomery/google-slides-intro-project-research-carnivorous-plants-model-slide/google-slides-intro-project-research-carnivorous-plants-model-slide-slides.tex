...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Google Slides - Intro Project, research carnivorous plants, model slide\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on google slides - intro project, research carnivorous plants, model slide. Watch first, then try it with me.
