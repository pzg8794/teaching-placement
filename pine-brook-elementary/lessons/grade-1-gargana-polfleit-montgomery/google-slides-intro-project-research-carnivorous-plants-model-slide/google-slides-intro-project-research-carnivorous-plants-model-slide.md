# 🟠 Google Slides - Intro Project, research carnivorous plants, model slide
...
- **LaTeX source:** [google-slides-intro-project-research-carnivorous-plants-model-slide.tex](./google-slides-intro-project-research-carnivorous-plants-model-slide.tex)
- **Bib file:** [google-slides-intro-project-research-carnivorous-plants-model-slide.bib](./google-slides-intro-project-research-carnivorous-plants-model-slide.bib)
- **Learning targets:** chromebook
- **Special education considerations:** I can use appropriate digital tools and resources to accomplish a task
...
- **Student slides (LaTeX):** [google-slides-intro-project-research-carnivorous-plants-model-slide-slides.tex](./google-slides-intro-project-research-carnivorous-plants-model-slide-slides.tex)
- **Student slides (PDF):** [google-slides-intro-project-research-carnivorous-plants-model-slide-slides.pdf](./google-slides-intro-project-research-carnivorous-plants-model-slide-slides.pdf)
...
- Today we are working on google slides - intro project, research carnivorous plants, model slide. Watch first, then try it with me.
