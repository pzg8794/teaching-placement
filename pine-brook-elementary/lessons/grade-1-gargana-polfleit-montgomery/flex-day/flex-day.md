...
- **Workbook sessions:** `Session 34, Session 35`
- **Months:** June
- **Class blocks:** Day 3 `12:25-1:15` Gargana, Day 3 `2:15-3:05` Polfleit, Day 5 `12:25-1:15` Montgomery
- **LaTeX source:** [flex-day.tex](./flex-day.tex)
- **Bib file:** [flex-day.bib](./flex-day.bib)
...
- **Student slides (LaTeX):** [flex-day-slides.tex](./flex-day-slides.tex)
- **Student slides (PDF):** [flex-day-slides.pdf](./flex-day-slides.pdf)
...
- Today we are working on flex day. Watch first, then try it with me.
