...
- **LaTeX source:** [algorithms-at-the-zoo.tex](./algorithms-at-the-zoo.tex)
- **Bib file:** [algorithms-at-the-zoo.bib](./algorithms-at-the-zoo.bib)

## 🎯 School Planning Goals + Inclusion

- **What is expected:** New Coding Pieces | (print & laminate) | Floor grid
...
- **Learning targets:** New Coding Pieces | (print & laminate) | Floor grid
- **Special education considerations:** K-1.CT.6: I can find and fix mistakes in a set of instructions to make them work correctly. | | K-1.CT.9: I can use symbols or pictures to represent ideas or information in a simple way.
