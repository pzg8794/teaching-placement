...
- **LaTeX source:** [them-s-the-rules.tex](./them-s-the-rules.tex)
- **Bib file:** [them-s-the-rules.bib](./them-s-the-rules.bib)
- **Learning targets:** Variety of slides
- **Special education considerations:** I can identify rules that I follow at home and in school when using computing technology. | I can explain what might happen if I didn’t follow rules when using computing technology.
...
- **Student slides (LaTeX):** [them-s-the-rules-slides.tex](./them-s-the-rules-slides.tex)
- **Student slides (PDF):** [them-s-the-rules-slides.pdf](./them-s-the-rules-slides.pdf)
...
- Today we are working on them's the rules!. Watch first, then try it with me.
