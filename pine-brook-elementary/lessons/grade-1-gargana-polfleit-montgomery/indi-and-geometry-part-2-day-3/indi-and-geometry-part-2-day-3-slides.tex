...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Indi \& Geometry | Part 2 (Day 3)\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on indi \& geometry | part 2 (day 3). Watch first, then try it with me.
