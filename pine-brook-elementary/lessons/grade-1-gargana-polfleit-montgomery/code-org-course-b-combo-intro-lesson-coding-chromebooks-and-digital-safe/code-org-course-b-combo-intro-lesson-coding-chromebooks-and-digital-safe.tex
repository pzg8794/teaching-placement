\documentclass[11pt]{article}
    ...
    \item Reference file: code-org-course-b-combo-intro-lesson-coding-chromebooks-and-digital-safe.bib
    \end{itemize}
    \section*{School Planning Goals and Inclusion}
    \begin{itemize}[leftmargin=*]
    \item What is expected: Assign Course B on Code,org to stundets in advance | | Student chromebooks
