...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Code.org | Course B Combo Intro. Lesson | Coding, Chromebooks, \& Digital Safety\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on code.org | course b combo intro. lesson | coding, chromebooks, \& digital safety. Watch first, then try it with me.
