...
\definecolor{accent1}{HTML}{DC2626}
\definecolor{accent2}{HTML}{FCA5A5}
\definecolor{accent3}{HTML}{2563EB}
\definecolor{accent4}{HTML}{7F1D1D}
\definecolor{paper}{HTML}{FFF8F8}
...
\title{Code.org | Course B Combo Intro. Lesson | Coding, Chromebooks, \& Digital Safety}
...
{\Huge\bfseries\color{ink} Code.org | Course B Combo Intro. Lesson | Coding, Chromebooks, \& Digital Safety\par}
\vspace{0.2cm}
{\Large\color{accent4} Notice. Think. Choose.\par}
\vspace{0.25cm}
\begin{tikzpicture}
\node[rounded corners=16pt, fill=white, draw=accent1, line width=1.2pt, text width=6.2cm, minimum height=1.35cm, align=center]
{\Large\bfseries Notice the problem, think it through, and make a smart choice.};
\end{tikzpicture}
\vspace{0.35cm}
\begin{tikzpicture}[node distance=0.45cm]
\node[rounded corners=14pt, fill=accent3!16, draw=accent3!80, minimum width=2.25cm, minimum height=1.1cm, align=center] (a) {\Large\bfseries 1\\[2pt]Spot it};
\node[rounded corners=14pt, fill=accent2!18, draw=accent2!85!black, minimum width=2.25cm, minimum height=1.1cm, align=center, right=of a] (b) {\Large\bfseries 2\\[2pt]Think it\\ through};
\node[rounded corners=14pt, fill=accent1!14, draw=accent1!80!black, minimum width=2.25cm, minimum height=1.1cm, align=center, right=of b] (c) {\Large\bfseries 3\\[2pt]Choose safely};
\end{tikzpicture}
\column{0.4\textwidth}
\begin{center}

\begin{tikzpicture}[x=1cm,y=1cm]
\path[fill=accent1!18, draw=accent4, line width=1pt]
  (2.5,4.45) -- (4.5,3.7) -- (4.15,1.8) .. controls (3.8,0.9) and (3.1,0.5) .. (2.5,0.2)
  .. controls (1.9,0.5) and (1.2,0.9) .. (0.85,1.8) -- (0.5,3.7) -- cycle;
\draw[rounded corners=0.12cm, fill=white, draw=accent3, line width=0.9pt] (1.75,2.0) rectangle (3.25,3.0);
\draw[accent3, line width=0.9pt] (2.0,2.0) -- (2.0,1.55) -- (3.0,1.55) -- (3.0,2.0);
\draw[accent3, line width=0.9pt] (2.1,3.0) arc (180:0:0.4 and 0.5);
\fill[accent2!70] (3.85,4.3) circle (0.15);
\fill[accent2!70] (4.2,4.65) circle (0.09);
\fill[accent2!70] (0.85,4.45) circle (0.12);
\end{tikzpicture}
...
\large Notice a digital safety problem and make a smart choice.
\end{block}
\vspace{0.1cm}
\begin{itemize}
\large
...
\node[rounded corners=0.16cm, fill=accent2!18, draw=accent2!85!black, text width=3.35cm, minimum height=1.2cm, align=center] at (2.3,2.85) {\small Notice the problem, think it through, and make a smart choice.};
...
\node[rounded corners=16pt, fill=accent3!16, draw=accent3!80, minimum width=3.3cm, minimum height=2.35cm, text width=2.45cm, align=center] (s1) {\Huge\bfseries 1\\[6pt]\Large Spot it};
\node[rounded corners=16pt, fill=accent2!18, draw=accent2!85!black, minimum width=3.3cm, minimum height=2.35cm, text width=2.45cm, align=center, right=of s1] (s2) {\Huge\bfseries 2\\[6pt]\Large Think it\\ through};
\node[rounded corners=16pt, fill=accent1!14, draw=accent1!80!black, minimum width=3.3cm, minimum height=2.35cm, text width=2.45cm, align=center, right=of s2] (s3) {\Huge\bfseries 3\\[6pt]\Large Choose safely};
...
\node[text width=3.7cm, align=center] at (2.5,2.4) {\small A good reason matters more than a quick answer.};
\draw[rounded corners=0.12cm, fill=accent3!16, draw=accent3!75] (0.4,0.65) rectangle (4.6,1.35);
\node[text width=3.7cm, align=center] at (2.5,1.0) {\small Safe choices should be easy to explain.};
\end{tikzpicture}
\end{columns}
