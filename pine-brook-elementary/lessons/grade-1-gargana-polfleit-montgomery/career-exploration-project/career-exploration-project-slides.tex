...
\end{tikzpicture}
\end{center}
\note{Today we are working on career exploration project}
\end{frame}
...
\Large Paper, crayons, markers, simple building materials
\end{block}
\vspace{0.15cm}
{\large\bfseries\color{coral} Success looks like this:}
\begin{itemize}\large
\item Paper, crayons, markers, simple building materials
