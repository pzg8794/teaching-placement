...
\title{Career Exploration Project.docx}
...
{\Huge\bfseries\color{ink} Career Exploration Project.docx\par}
\vspace{0.2cm}
...
\node[text width=3.7cm, align=center] at (2.5,2.4) {\small A visible example helps us stay on track.};
