...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Career Exploration Project.docx\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on career exploration project.docx. Watch first, then try it with me.
