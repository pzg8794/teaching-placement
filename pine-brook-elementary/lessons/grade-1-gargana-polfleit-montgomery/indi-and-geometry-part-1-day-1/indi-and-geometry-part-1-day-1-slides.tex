...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Indi \& Geometry | Part 1 (Day 1)\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on indi \& geometry | part 1 (day 1). Watch first, then try it with me.
