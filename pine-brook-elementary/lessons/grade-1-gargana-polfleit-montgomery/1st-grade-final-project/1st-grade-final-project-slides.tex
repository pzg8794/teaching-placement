...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge 1st Grade Final Project\par}
\vspace{0.3cm}
...
\begin{itemize}
\item Planning Page: Final Project - 1st (PRINT)
\item Rubric (in lesson)
\item Variety of mterials through the year based on student choice
\end{itemize}
...
\footnotesize
\begin{itemize}
\item Today we are working on 1st grade final project. Watch first, then try it with me.
