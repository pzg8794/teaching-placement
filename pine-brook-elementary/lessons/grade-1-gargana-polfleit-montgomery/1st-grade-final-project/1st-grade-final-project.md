...
- **LaTeX source:** [1st-grade-final-project.tex](./1st-grade-final-project.tex)
- **Bib file:** [1st-grade-final-project.bib](./1st-grade-final-project.bib)
- **Learning targets:** Planning Page: Final Project - 1st (PRINT) | | Rubric (in lesson) | | Variety of mterials through the year based on student choice
- **Special education considerations:** I can use technology based tools to communicate ideas | I can use the features of book creator or Google Slides to communicate my ideas | I can understand that technology helps me create and share my ideas.
...
- **Student slides (LaTeX):** [1st-grade-final-project-slides.tex](./1st-grade-final-project-slides.tex)
- **Student slides (PDF):** [1st-grade-final-project-slides.pdf](./1st-grade-final-project-slides.pdf)
...
- Today we are working on 1st grade final project. Watch first, then try it with me.
