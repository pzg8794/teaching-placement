...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Interactive Word Wall Build\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on interactive word wall build. Watch first, then try it with me.
