...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Physical Storage Devices\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on physical storage devices. Watch first, then try it with me.
