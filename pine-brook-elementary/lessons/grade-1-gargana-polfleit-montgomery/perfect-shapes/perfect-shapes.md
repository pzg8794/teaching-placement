...
- **LaTeX source:** [perfect-shapes.tex](./perfect-shapes.tex)
- **Bib file:** [perfect-shapes.bib](./perfect-shapes.bib)
- **Learning targets:** Paper | Pencils | Chromebooks | Drawing App (Chrome Canvas) | Chart paper or someplace to record student thinking
- **Special education considerations:** .I can describe how tasks can be done with or without computing technology.
...
- **Student slides (LaTeX):** [perfect-shapes-slides.tex](./perfect-shapes-slides.tex)
- **Student slides (PDF):** [perfect-shapes-slides.pdf](./perfect-shapes-slides.pdf)
...
- Today we are working on perfect shapes. Watch first, then try it with me.
