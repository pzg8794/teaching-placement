...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Public vs Private Spaces\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on public vs private spaces. Watch first, then try it with me.
