...
\item Reference file: stack-the-code.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: Algorithm for each station (print slides 7-10) | Student work page (print slide 11) | Cups to stack - 10 for each group
