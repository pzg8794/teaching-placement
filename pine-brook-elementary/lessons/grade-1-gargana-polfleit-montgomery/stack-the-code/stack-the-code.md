...
- **LaTeX source:** [stack-the-code.tex](./stack-the-code.tex)
- **Bib file:** [stack-the-code.bib](./stack-the-code.bib)

## 🎯 School Planning Goals + Inclusion

- **What is expected:** Algorithm for each station (print slides 7-10) | Student work page (print slide 11) | Cups to stack - 10 for each group
...
- **Learning targets:** Algorithm for each station (print slides 7-10) | Student work page (print slide 11) | Cups to stack - 10 for each group
- **Special education considerations:** I can identify patterns in an algorithm | I can successfully complete an algorithm and debug if necessary | I can communicate positively with my peers
