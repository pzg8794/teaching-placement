...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge My First Experience with Coding\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on my first experience with coding. Watch first, then try it with me.
