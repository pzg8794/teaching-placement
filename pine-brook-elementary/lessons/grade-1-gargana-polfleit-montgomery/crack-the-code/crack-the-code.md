...
- **LaTeX source:** [crack-the-code.tex](./crack-the-code.tex)
- **Bib file:** [crack-the-code.bib](./crack-the-code.bib)
- **Learning targets:** Bead (2 colors) | Pipe Cleaners or string | Mosrse code alphabet chart
- **Special education considerations:** I can break down the steps of creating a Morse code bracelet and put them in the correct order (K-1.CT.2) | I can identify the pattern of dots and dashes in Morse code and use it to spell words. (K-1.CT.1)
...
- **Student slides (LaTeX):** [crack-the-code-slides.tex](./crack-the-code-slides.tex)
- **Student slides (PDF):** [crack-the-code-slides.pdf](./crack-the-code-slides.pdf)
...
- Today we are working on crack the code. Watch first, then try it with me.
