...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Crack the Code\par}
\vspace{0.3cm}
...
\begin{itemize}
\item Bead (2 colors)
\item Pipe Cleaners or string
\item Mosrse code alphabet chart
\end{itemize}
...
\footnotesize
\begin{itemize}
\item Today we are working on crack the code. Watch first, then try it with me.
