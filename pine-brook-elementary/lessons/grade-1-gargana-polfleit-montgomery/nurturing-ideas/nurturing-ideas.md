...
- **LaTeX source:** [nurturing-ideas.tex](./nurturing-ideas.tex)
- **Bib file:** [nurturing-ideas.bib](./nurturing-ideas.bib)
- **Learning targets:** read-aloud book "What Do You Do With an Idea?" | Slides | Building materials
- **Special education considerations:** I can recognize and define a problem. | I can break down a problem into smaller parts. | I can identify multiple ways to solve a problem.
...
- **Student slides (LaTeX):** [nurturing-ideas-slides.tex](./nurturing-ideas-slides.tex)
- **Student slides (PDF):** [nurturing-ideas-slides.pdf](./nurturing-ideas-slides.pdf)
...
- Today we are working on nurturing ideas. Watch first, then try it with me.
