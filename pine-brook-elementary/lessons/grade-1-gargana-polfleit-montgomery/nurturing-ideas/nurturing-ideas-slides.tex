...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Nurturing Ideas\par}
\vspace{0.3cm}
...
\begin{itemize}
\item read-aloud book "What Do You Do With an Idea?"
\item Slides
...
\footnotesize
\begin{itemize}
\item Today we are working on nurturing ideas. Watch first, then try it with me.
