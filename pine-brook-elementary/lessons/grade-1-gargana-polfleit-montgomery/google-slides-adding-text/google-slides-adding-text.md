...
- **LaTeX source:** [google-slides-adding-text.tex](./google-slides-adding-text.tex)
- **Bib file:** [google-slides-adding-text.bib](./google-slides-adding-text.bib)
...
- **Student slides (LaTeX):** [google-slides-adding-text-slides.tex](./google-slides-adding-text-slides.tex)
- **Student slides (PDF):** [google-slides-adding-text-slides.pdf](./google-slides-adding-text-slides.pdf)
...
- Today we are working on google slides - adding text. Watch first, then try it with me.
