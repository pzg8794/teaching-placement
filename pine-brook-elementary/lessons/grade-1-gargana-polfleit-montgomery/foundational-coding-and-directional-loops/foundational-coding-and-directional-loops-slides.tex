...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Foundational Coding and Directional Loops\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on foundational coding and directional loops. Watch first, then try it with me.
