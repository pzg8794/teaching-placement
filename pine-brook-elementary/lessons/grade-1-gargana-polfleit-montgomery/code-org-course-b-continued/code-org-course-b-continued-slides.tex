...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Code.Org Course B Continued\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on code.org course b continued. Watch first, then try it with me.
