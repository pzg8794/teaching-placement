...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Sending Messages with Sound\par}
\vspace{0.3cm}
...
\begin{itemize}
\item Worksheet (last page of lesson)
\end{itemize}
...
\footnotesize
\begin{itemize}
\item Today we are working on sending messages with sound. Watch first, then try it with me.
