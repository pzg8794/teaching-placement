...
- **Workbook sessions:** `Session 4, Session 5`
- **Months:** September, October
- **Class blocks:** Day 3 `12:25-1:15` Gargana, Day 3 `2:15-3:05` Polfleit, Day 5 `12:25-1:15` Montgomery
- **LaTeX source:** [technology-in-different-careers.tex](./technology-in-different-careers.tex)
- **Bib file:** [technology-in-different-careers.bib](./technology-in-different-careers.bib)
- **Learning targets:** Chart Paper, markers or blank Google slides | Career and technology in specific career cards (Cards) | Images will need to be printed and cut out for each class | Send to print shop | At least a set for each group of kids
- **Special education considerations:** What kinds of jobs use computers or other technology? | What types of technology do people use in their careers? | How might technology help me when I am older?
...
- **Student slides (LaTeX):** [technology-in-different-careers-slides.tex](./technology-in-different-careers-slides.tex)
- **Student slides (PDF):** [technology-in-different-careers-slides.pdf](./technology-in-different-careers-slides.pdf)
...
- Today we are working on technology in different careers. Watch first, then try it with me.
