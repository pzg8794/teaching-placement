...
\end{tikzpicture}
\end{center}
\note{Today we are working on technology in different careers}
\end{frame}
...
\Large Chart Paper, markers or blank Google slides
\end{block}
\vspace{0.15cm}
{\large\bfseries\color{coral} Success looks like this:}
\begin{itemize}\large
\item Chart Paper, markers or blank Google slides
\item Career and technology in specific career cards (Cards)
\item Images will need to be printed and cut out for each class
\end{itemize}
\column{0.4\textwidth}
