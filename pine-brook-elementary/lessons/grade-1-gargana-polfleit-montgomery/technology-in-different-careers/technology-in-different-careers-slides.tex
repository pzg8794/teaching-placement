...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Technology in Different Careers\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on technology in different careers. Watch first, then try it with me.
