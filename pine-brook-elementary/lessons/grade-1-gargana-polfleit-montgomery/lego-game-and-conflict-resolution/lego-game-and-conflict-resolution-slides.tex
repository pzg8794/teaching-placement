...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge LEGO Game and Conflict Resolution\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on lego game and conflict resolution. Watch first, then try it with me.
