...
\end{tikzpicture}
\end{center}
\note{Today we are working on you're an engineer}
\end{frame}
...
\Large I can describe what an engineer does
\end{block}
\vspace{0.15cm}
{\large\bfseries\color{coral} Success looks like this:}
\begin{itemize}\large
\item I can describe what an engineer does
\item I can identify a problem and come up with an idea to solve the problem (K-1.CT.4)
\item I can explain the steps used to solve a problem (Engineer \& Design Process)
\end{itemize}
\column{0.4\textwidth}
