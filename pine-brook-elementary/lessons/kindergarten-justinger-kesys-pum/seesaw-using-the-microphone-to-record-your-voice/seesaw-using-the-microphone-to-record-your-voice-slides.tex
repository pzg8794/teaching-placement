...
\title{SeeSaw: Using the microphone to record your voice}
...
\vspace{0.35cm}
\begin{center}
{\Huge\bfseries\color{ink} SeeSaw: Using the microphone to record your voice\par}
\vspace{0.2cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on seesaw: using the microphone}
\end{frame}
