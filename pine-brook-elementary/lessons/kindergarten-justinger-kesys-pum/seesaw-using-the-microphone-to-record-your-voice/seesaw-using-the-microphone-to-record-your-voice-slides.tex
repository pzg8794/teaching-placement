...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge SeeSaw: Using the microphone to record your voice\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on seesaw: using the microphone to record your voice. Watch first, then try it with me.
