\documentclass[11pt]{article}
    ...
    \item Reference file: seesaw-using-the-microphone-to-record-your-voice.bib
    \end{itemize}
    \section*{School Planning Goals and Inclusion}
    \begin{itemize}[leftmargin=*]
    \item What is expected: K-1.DL.4: I can use SeeSaw to create a digital artifact. | K-1.CT.4: I can break a task into smaller steps. | K-1.CT.6: I can follow steps (an algorithm) to complete a task.
