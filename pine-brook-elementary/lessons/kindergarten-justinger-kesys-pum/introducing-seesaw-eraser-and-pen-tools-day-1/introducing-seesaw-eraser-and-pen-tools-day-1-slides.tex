...
\title{Introducing SeeSaw | (Eraser \& Pen Tools) | Day 1}
...
\vspace{0.35cm}
\begin{center}
{\Huge\bfseries\color{ink} Introducing SeeSaw | (Eraser \& Pen Tools) | Day 1\par}
\vspace{0.2cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on introducing seesaw | |}
\end{frame}
