...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Introducing SeeSaw | (Eraser \& Pen Tools) | Day 1\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on introducing seesaw | (eraser \& pen tools) | day 1. Watch first, then try it with me.
