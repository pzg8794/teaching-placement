# 🟡 Introducing SeeSaw | (Eraser & Pen Tools) | Day 1
...
- **LaTeX source:** [introducing-seesaw-eraser-and-pen-tools-day-1.tex](./introducing-seesaw-eraser-and-pen-tools-day-1.tex)
- **Bib file:** [introducing-seesaw-eraser-and-pen-tools-day-1.bib](./introducing-seesaw-eraser-and-pen-tools-day-1.bib)
- **Audience profile:** [class-audience-profile.md](../class-audience-profile.md)
- **Student slides (LaTeX):** [introducing-seesaw-eraser-and-pen-tools-day-1-slides.tex](./introducing-seesaw-eraser-and-pen-tools-day-1-slides.tex)
- **Student slides (PDF):** [introducing-seesaw-eraser-and-pen-tools-day-1-slides.pdf](./introducing-seesaw-eraser-and-pen-tools-day-1-slides.pdf)

## 🎯 School Planning Goals + Inclusion

- **What is expected:** K-1.IC.6: I can identify different ways to interact with a chromebook (touchscreen, touchpad, workspace, toolbars, etc) | K-1.DL.2 & K-1.DL.4: | I can use the eraser tool in SeeSaw | I can use the pen tool in SeeSaw | K-1.NSD.3: I can use the undo button when I make a mistake.
...
- Today we are working on introducing seesaw | (eraser & pen tools) | day 1. Watch first, then try it with me.
