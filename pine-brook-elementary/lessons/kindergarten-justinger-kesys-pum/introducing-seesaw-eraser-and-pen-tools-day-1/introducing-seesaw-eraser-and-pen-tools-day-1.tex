\documentclass[11pt]{article}
    ...
    \item Reference file: introducing-seesaw-eraser-and-pen-tools-day-1.bib
    \end{itemize}
    \section*{School Planning Goals and Inclusion}
    \begin{itemize}[leftmargin=*]
    \item What is expected: K-1.IC.6: I can identify different ways to interact with a chromebook (touchscreen, touchpad, workspace, toolbars, etc) | K-1.DL.2 & K-1.DL.4: | I can use the eraser tool in SeeSaw | I can use the pen tool in SeeSaw | K-1.NSD.3: I can use the undo button when I make a mistake.
