...
- **LaTeX source:** [getting-started-with-book-creator.tex](./getting-started-with-book-creator.tex)
- **Bib file:** [getting-started-with-book-creator.bib](./getting-started-with-book-creator.bib)
...
- **Student slides (LaTeX):** [getting-started-with-book-creator-slides.tex](./getting-started-with-book-creator-slides.tex)
- **Student slides (PDF):** [getting-started-with-book-creator-slides.pdf](./getting-started-with-book-creator-slides.pdf)
...
- Today we are working on getting started with book creator. Watch first, then try it with me.
