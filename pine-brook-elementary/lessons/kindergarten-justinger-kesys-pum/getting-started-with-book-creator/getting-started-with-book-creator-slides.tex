...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Getting Started with Book Creator\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on getting started with book creator. Watch first, then try it with me.
