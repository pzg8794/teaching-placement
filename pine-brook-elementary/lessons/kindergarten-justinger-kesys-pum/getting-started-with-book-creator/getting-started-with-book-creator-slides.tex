...
\end{center}
\end{columns}
\note{Audience guidance: Early elementary learners who benefit from visual modeling, predictable routines, and very small chunks of task. Teaching move: Model the first screen and the exact tool students must use before release.}
\end{frame}
