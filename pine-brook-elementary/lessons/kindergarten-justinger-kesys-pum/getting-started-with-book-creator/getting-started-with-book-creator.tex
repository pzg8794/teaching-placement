\documentclass[11pt]{article}
    ...
    \item Reference file: getting-started-with-book-creator.bib
    \end{itemize}
    \section*{School Planning Goals and Inclusion}
    \begin{itemize}[leftmargin=*]
    \item What is expected: K-1.IC.1: I can identify how books can be read and created both with and without computing devices. | | K-1.CY.2: I can explain how my accounts (chromebook, Book Creator Library, etc.) are kept secure. | | K-1.CY.4: I can decode words using a simple code.
