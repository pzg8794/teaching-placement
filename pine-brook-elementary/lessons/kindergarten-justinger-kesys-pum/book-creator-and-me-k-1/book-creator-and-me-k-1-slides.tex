...
\vspace{0.35cm}
\begin{center}
{\Huge\bfseries\color{ink} Book Creator \& Me, K-1\par}
\vspace{0.2cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on book creator \& me,}
\end{frame}
...
\Large K-1.DL.4: I can create a digital book
\end{block}
\vspace{0.15cm}
{\large\bfseries\color{coral} Success looks like this:}
\begin{itemize}\large
\item K-1.DL.4: I can create a digital book
\item I can learn to use a variety of digital tools
