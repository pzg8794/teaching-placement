...
\item Reference file: welcome-to-ignite.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: We can collect data about material choices (K-1.CT.2) | We can create a visual chart of the data we collect (K-1.CT.3) | I can build my name by breaking the task down into smaller parts (K-1.CT.4)
