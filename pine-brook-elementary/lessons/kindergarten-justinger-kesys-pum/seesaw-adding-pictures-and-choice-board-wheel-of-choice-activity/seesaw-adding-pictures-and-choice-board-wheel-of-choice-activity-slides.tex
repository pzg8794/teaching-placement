...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge SeeSaw: Adding Pictures \& Choice Board/ Wheel of Choice Activity\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on seesaw: adding pictures \& choice board/ wheel of choice activity. Watch first, then try it with me.
