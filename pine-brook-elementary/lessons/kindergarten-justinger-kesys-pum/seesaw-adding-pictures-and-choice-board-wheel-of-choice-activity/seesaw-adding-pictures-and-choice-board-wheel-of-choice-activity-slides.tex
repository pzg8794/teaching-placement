...
\title{SeeSaw: Adding Pictures \& Choice Board/ Wheel of Choice Activity}
...
\vspace{0.35cm}
\begin{center}
{\Huge\bfseries\color{ink} SeeSaw: Adding Pictures \& Choice Board/ Wheel of Choice Activity\par}
\vspace{0.2cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on seesaw: adding pictures \&}
\end{frame}
