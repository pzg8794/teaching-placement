# 🟡 SeeSaw: Adding Pictures & Choice Board/ Wheel of Choice Activity
...
- **Workbook sessions:** `Session 29`
- **Months:** May
- **Class blocks:** Day 1 `12:25-1:15` Justinger, Day 2 `12:25-1:15` Kesys, Day 4 `12:25-1:15` Pum
- **LaTeX source:** [seesaw-adding-pictures-and-choice-board-wheel-of-choice-activity.tex](./seesaw-adding-pictures-and-choice-board-wheel-of-choice-activity.tex)
- **Bib file:** [seesaw-adding-pictures-and-choice-board-wheel-of-choice-activity.bib](./seesaw-adding-pictures-and-choice-board-wheel-of-choice-activity.bib)
- **Audience profile:** [class-audience-profile.md](../class-audience-profile.md)
- **Student slides (LaTeX):** [seesaw-adding-pictures-and-choice-board-wheel-of-choice-activity-slides.tex](./seesaw-adding-pictures-and-choice-board-wheel-of-choice-activity-slides.tex)
- **Student slides (PDF):** [seesaw-adding-pictures-and-choice-board-wheel-of-choice-activity-slides.pdf](./seesaw-adding-pictures-and-choice-board-wheel-of-choice-activity-slides.pdf)

## 🎯 School Planning Goals + Inclusion

- **What is expected:** K-1.DL.4: I can use SeeSaw to create a digital artifact. | K-1.CT.4: I can break a task into smaller steps. | K-1.CT.6: I can follow steps (an algorithm) to complete a task.
...
- Today we are working on seesaw: adding pictures & choice board/ wheel of choice activity. Watch first, then try it with me.
...
- [Seesaw Instructional Design](https://seesaw.com/instructional-design/)
