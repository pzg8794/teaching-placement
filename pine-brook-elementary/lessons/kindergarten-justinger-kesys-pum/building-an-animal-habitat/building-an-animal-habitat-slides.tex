...
\end{tikzpicture}
\end{center}
\note{Today we are working on building an animal habitat}
\end{frame}
...
\Large I can identify a problem and come up with an idea to solve the problem (K-1.CT.4)
\end{block}
\vspace{0.15cm}
...
\item I can use the Engineer \& Design Process to build a zoo habitat for my animal.
