...
{\Huge\bfseries\color{ink} Building An Animal Habitat\par}
\vspace{0.2cm}
...
\end{center}
\end{columns}
\note{Audience guidance: Early elementary learners who benefit from visual modeling, predictable routines, and very small chunks of task. Teaching move: Make the challenge criteria visible from the first slide through cleanup.}
\end{frame}
...
\large Design a solution, build it, and make it better.
\end{block}
\vspace{0.1cm}
\begin{itemize}
\large
