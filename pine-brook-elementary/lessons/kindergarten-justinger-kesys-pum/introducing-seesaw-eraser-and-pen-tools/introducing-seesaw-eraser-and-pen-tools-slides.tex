...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Introducing SeeSaw | (Eraser \& Pen Tools)\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on introducing seesaw | (eraser \& pen tools). Watch first, then try it with me.
