# 🟡 Coding with code.org | (Course A) | Programming with Scrat
...
- **LaTeX source:** [coding-with-code-org-course-a-programming-with-scrat.tex](./coding-with-code-org-course-a-programming-with-scrat.tex)
- **Bib file:** [coding-with-code-org-course-a-programming-with-scrat.bib](./coding-with-code-org-course-a-programming-with-scrat.bib)
- **Audience profile:** [class-audience-profile.md](../class-audience-profile.md)
- **Student slides (LaTeX):** [coding-with-code-org-course-a-programming-with-scrat-slides.tex](./coding-with-code-org-course-a-programming-with-scrat-slides.tex)
- **Student slides (PDF):** [coding-with-code-org-course-a-programming-with-scrat-slides.pdf](./coding-with-code-org-course-a-programming-with-scrat-slides.pdf)
...
- Today we are working on coding with code.org | (course a) | programming with scrat. Watch first, then try it with me.
