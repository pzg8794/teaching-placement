# 🟡 Using a Chromebook | Quick Cards | Apps | iReady | Shutting down
...
- **LaTeX source:** [using-a-chromebook-quick-cards-apps-iready-shutting-down.tex](./using-a-chromebook-quick-cards-apps-iready-shutting-down.tex)
- **Bib file:** [using-a-chromebook-quick-cards-apps-iready-shutting-down.bib](./using-a-chromebook-quick-cards-apps-iready-shutting-down.bib)
...
- **Student slides (LaTeX):** [using-a-chromebook-quick-cards-apps-iready-shutting-down-slides.tex](./using-a-chromebook-quick-cards-apps-iready-shutting-down-slides.tex)
- **Student slides (PDF):** [using-a-chromebook-quick-cards-apps-iready-shutting-down-slides.pdf](./using-a-chromebook-quick-cards-apps-iready-shutting-down-slides.pdf)
...
- Today we are working on using a chromebook | quick cards | apps | iready | shutting down. Watch first, then try it with me.
