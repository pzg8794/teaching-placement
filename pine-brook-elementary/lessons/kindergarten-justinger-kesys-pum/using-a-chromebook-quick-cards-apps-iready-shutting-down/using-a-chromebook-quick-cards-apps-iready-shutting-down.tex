...
\item Reference file: using-a-chromebook-quick-cards-apps-iready-shutting-down.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: K-1.IC.6 With teacher support, identify different ways people interact with computers and computing devices.
