...
\title{Using a Chromebook | Quick Cards | Apps | iReady | Shutting down}
...
{\Huge\bfseries\color{ink} Using a Chromebook | Quick Cards | Apps | iReady | Shutting down\par}
\vspace{0.2cm}
...
\large Use technology tools carefully and solve simple problems.
\end{block}
\vspace{0.1cm}
\begin{itemize}
\large
