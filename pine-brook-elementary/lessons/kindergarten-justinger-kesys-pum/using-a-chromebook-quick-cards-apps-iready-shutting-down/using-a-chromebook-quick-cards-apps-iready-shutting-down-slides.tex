...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Using a Chromebook | Quick Cards | Apps | iReady | Shutting down\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on using a chromebook | quick cards | apps | iready | shutting down. Watch first, then try it with me.
