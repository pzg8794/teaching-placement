...
\end{tikzpicture}
\end{center}
\note{Today we are working on using a chromebook |}
\end{frame}
...
\Large K-1.IC.6 With teacher support, identify different ways people interact with computers and computing devices.
\end{block}
\vspace{0.15cm}
