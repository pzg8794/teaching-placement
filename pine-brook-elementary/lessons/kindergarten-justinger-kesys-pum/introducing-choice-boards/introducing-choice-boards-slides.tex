...
\Large Students will be able to define a choice board and explain its purpose in learning
\end{block}
\vspace{0.15cm}
{\large\bfseries\color{coral} Success looks like this:}
\begin{itemize}\large
\item Students will be able to define a choice board and explain its purpose in learning
\item Students will be able to describe the function of a QR code and demonstrate how to scan and access information using a QR code.
