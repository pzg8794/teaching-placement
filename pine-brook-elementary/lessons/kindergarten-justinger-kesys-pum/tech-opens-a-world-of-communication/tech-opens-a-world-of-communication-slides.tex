...
\end{tikzpicture}
\end{center}
\note{Today we are working on tech opens a world}
\end{frame}
...
\Large I can discuss how people communicate with and without technology (K-1.IC.1)
\end{block}
\vspace{0.15cm}
{\large\bfseries\color{coral} Success looks like this:}
\begin{itemize}\large
\item I can discuss how people communicate with and without technology (K-1.IC.1)
\item I can explain the “rules” that help people share information over long distances (K-1.NSD.4)
\item I can use SeeSaw to share what I learned with others (K-1.DL.2)
\end{itemize}
\column{0.4\textwidth}
...
{\Huge\bfseries 1\\[6pt]\Large Anchor the abstract idea in a concrete};
...
{\Huge\bfseries 2\\[6pt]\Large Use one discussion prompt at a time};
...
\begin{itemize}\large
\item Too many examples at once can blur the core message
