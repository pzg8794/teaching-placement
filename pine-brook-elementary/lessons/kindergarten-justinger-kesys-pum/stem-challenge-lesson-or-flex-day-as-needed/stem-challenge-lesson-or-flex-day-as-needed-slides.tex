...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge STEM Challenge Lesson or FLEX Day as needed\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on stem challenge lesson or flex day as needed. Watch first, then try it with me.
