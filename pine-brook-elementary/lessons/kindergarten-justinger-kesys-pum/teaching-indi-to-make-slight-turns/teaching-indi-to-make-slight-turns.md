# 🟡 Teaching Indi to make slight turns
...
- **Workbook sessions:** `Session 25`
- **Months:** April
- **Class blocks:** Day 1 `12:25-1:15` Justinger, Day 2 `12:25-1:15` Kesys, Day 4 `12:25-1:15` Pum
- **LaTeX source:** [teaching-indi-to-make-slight-turns.tex](./teaching-indi-to-make-slight-turns.tex)
- **Bib file:** [teaching-indi-to-make-slight-turns.bib](./teaching-indi-to-make-slight-turns.bib)
- **Audience profile:** [class-audience-profile.md](../class-audience-profile.md)
- **Student slides (LaTeX):** [teaching-indi-to-make-slight-turns-slides.tex](./teaching-indi-to-make-slight-turns-slides.tex)
- **Student slides (PDF):** [teaching-indi-to-make-slight-turns-slides.pdf](./teaching-indi-to-make-slight-turns-slides.pdf)

## 🎯 School Planning Goals + Inclusion

- **What is expected:** I can identify key parts of Indi and what they do (K-1.NSD.2) | I can teach someone else about Indi and how it works (using color mats for input & output) (K-1.NSD.1) | I can show Indi how to travel in different directions (K-1.NSD.1) | I can follow an algorithm to complete a task (K-1.CT.6) | I can makes changes to my program when it is not working (K-1.CT.9) | I can program Indi to travel along different paths and around objects (K-1.CT.10)
...
- Today we are working on teaching indi to make slight turns. Watch first, then try it with me.
