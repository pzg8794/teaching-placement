...
\end{tikzpicture}
\end{center}
\note{Today we are working on teaching indi to make}
\end{frame}
...
{\Huge\bfseries 1\\[6pt]\Large Assign partner roles before materials come out};
...
{\Huge\bfseries 2\\[6pt]\Large Model one test-revise cycle with the actual};
...
{\Huge\bfseries 3\\[6pt]\Large Use a simple data language such as};
...
\item One partner may take over unless roles are named and revisited
