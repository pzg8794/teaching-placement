...
\item Reference file: tasks-and-technology-build-a-house.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: I can tell you what the word technology means | I can tell you what the word task means | I can give an example of a task that is completed with and without computing technology (K-1.IC.1)
