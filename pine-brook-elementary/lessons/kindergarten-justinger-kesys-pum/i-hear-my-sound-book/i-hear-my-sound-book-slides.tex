...
\end{tikzpicture}
\end{center}
\note{Today we are working on i hear}
\end{frame}
...
\Large K-1.DL.1: Use digital tools to create and communicate
\end{block}
\vspace{0.15cm}
{\large\bfseries\color{coral} Success looks like this:}
\begin{itemize}\large
\item K-1.DL.1: Use digital tools to create and communicate
\item K-1.IC.6: With teacher support, identify different ways people interact with computers and computing devices
\item K-1.DL.2: With teacher guidance, navigate and use common features of digital tools and environments
\end{itemize}
\column{0.4\textwidth}
