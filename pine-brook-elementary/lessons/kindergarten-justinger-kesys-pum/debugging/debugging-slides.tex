...
\end{tikzpicture}
\end{center}
\note{Today we are working on debugging}
\end{frame}
...
\Large I can find and fix mistakes (bugs) in an algorithm (K-1.CT.9)
\end{block}
\vspace{0.15cm}
{\large\bfseries\color{coral} Success looks like this:}
\begin{itemize}\large
\item I can find and fix mistakes (bugs) in an algorithm (K-1.CT.9)
