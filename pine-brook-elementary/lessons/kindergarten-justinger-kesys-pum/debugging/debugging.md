...
- **LaTeX source:** [debugging.tex](./debugging.tex)
- **Bib file:** [debugging.bib](./debugging.bib)
...
- **Student slides (LaTeX):** [debugging-slides.tex](./debugging-slides.tex)
- **Student slides (PDF):** [debugging-slides.pdf](./debugging-slides.pdf)
...
- Today we are working on debugging. Watch first, then try it with me.
