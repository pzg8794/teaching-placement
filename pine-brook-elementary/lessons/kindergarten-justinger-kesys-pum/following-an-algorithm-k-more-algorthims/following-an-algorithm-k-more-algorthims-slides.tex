...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Following an Algorithm K - More Algorthims\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on following an algorithm k - more algorthims. Watch first, then try it with me.
