...
\Large I can follow an algorithm to complete a task. K-1.CT.6
\end{block}
\vspace{0.15cm}
{\large\bfseries\color{coral} Success looks like this:}
\begin{itemize}\large
\item I can follow an algorithm to complete a task. K-1.CT.6
\item I can identify and fix (debug) errors within a simple algorithm. K-1.CT.9
\item I can collaboratively create a plan that outlines the steps needed to complete a task. K-1.CT.10
\end{itemize}
\column{0.4\textwidth}
