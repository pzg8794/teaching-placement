\documentclass[11pt]{article}
    ...
    \item Reference file: responsible-use-of-devices.bib
    \end{itemize}
    \section*{School Planning Goals and Inclusion}
    \begin{itemize}[leftmargin=*]
    \item What is expected: K-1.NSD.1: I can identify ways people provide input and get output from computing devices. | K-1.NSD.2: I can name/label parts of a chromebook (computer hardware)
