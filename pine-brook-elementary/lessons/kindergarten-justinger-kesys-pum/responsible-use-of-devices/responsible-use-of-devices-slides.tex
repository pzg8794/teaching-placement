...
\title{Responsible Use of Devices}
...
{\Huge\bfseries\color{ink} Responsible Use of Devices\par}
\vspace{0.2cm}
...
\node[text width=3.7cm, align=center] at (2.5,2.4) {\small A checklist helps us remember what to try next.};
