...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Responsible Use of Devices\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on responsible use of devices. Watch first, then try it with me.
