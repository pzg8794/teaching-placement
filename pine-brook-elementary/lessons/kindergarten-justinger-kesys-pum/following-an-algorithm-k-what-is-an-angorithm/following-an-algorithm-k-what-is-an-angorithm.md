# 🟡 Following an Algorithm K - What is an Angorithm
...
- **LaTeX source:** [following-an-algorithm-k-what-is-an-angorithm.tex](./following-an-algorithm-k-what-is-an-angorithm.tex)
- **Bib file:** [following-an-algorithm-k-what-is-an-angorithm.bib](./following-an-algorithm-k-what-is-an-angorithm.bib)
- **Audience profile:** [class-audience-profile.md](../class-audience-profile.md)
- **Student slides (LaTeX):** [following-an-algorithm-k-what-is-an-angorithm-slides.tex](./following-an-algorithm-k-what-is-an-angorithm-slides.tex)
- **Student slides (PDF):** [following-an-algorithm-k-what-is-an-angorithm-slides.pdf](./following-an-algorithm-k-what-is-an-angorithm-slides.pdf)

## 🎯 School Planning Goals + Inclusion

- **What is expected:** I can follow steps (in an algorithm) to complete a task (K-1.CT.6 ) | I understand that tasks can be described in different ways (K-1.CT.5) | I can tell which steps are repeated in a task (K-1.CT.8) | I can make a plan with steps (K-1.CT.10)
...
- Today we are working on following an algorithm k - what is an angorithm. Watch first, then try it with me.
