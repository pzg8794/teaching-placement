...
\end{tikzpicture}
\end{center}
\note{Today we are working on intro}
\end{frame}
...
\Large I can tell the steps needed to complete a daily task. (K-1.CT.4 Identify a problem or task and discuss ways to break it into multiple smaller steps.)
\end{block}
\vspace{0.15cm}
{\large\bfseries\color{coral} Success looks like this:}
\begin{itemize}\large
\item I can tell the steps needed to complete a daily task. (K-1.CT.4 Identify a problem or task and discuss ways to break it into multiple smaller steps.)
\item I can work with others to make a plan with steps to complete a task (K-1.CT.10 Collaboratively create a plan that outlines the steps needed to complete a task.)
...
{\Huge\bfseries 1\\[6pt]\Large Pick one clear idea};
...
\begin{itemize}\large
\item Hidden assumptions in the directions can make support requests pile up
