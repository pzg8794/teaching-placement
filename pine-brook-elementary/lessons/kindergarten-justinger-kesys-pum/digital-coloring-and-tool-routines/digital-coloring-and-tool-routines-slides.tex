...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Digital Coloring and Tool Routines\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on digital coloring and tool routines. Watch first, then try it with me.
