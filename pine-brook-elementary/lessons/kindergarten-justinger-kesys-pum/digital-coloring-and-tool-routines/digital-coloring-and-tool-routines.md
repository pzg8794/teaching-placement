...
- **Compiled PDF:** [digital-coloring-and-tool-routines.pdf](./digital-coloring-and-tool-routines.pdf)
- **Audience profile:** [class-audience-profile.md](../class-audience-profile.md)
- **Student slides (LaTeX):** [digital-coloring-and-tool-routines-slides.tex](./digital-coloring-and-tool-routines-slides.tex)
- **Student slides (PDF):** [digital-coloring-and-tool-routines-slides.pdf](./digital-coloring-and-tool-routines-slides.pdf)
...
- Today we are working on digital coloring and tool routines. Watch first, then try it with me.
...
- Open with a short model that names the lesson focus: digital tool onboarding, recording, and visual-response routines.
