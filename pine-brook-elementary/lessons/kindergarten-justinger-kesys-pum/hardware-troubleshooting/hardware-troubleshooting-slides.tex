...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Hardware Troubleshooting\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on hardware troubleshooting. Watch first, then try it with me.
