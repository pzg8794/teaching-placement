...
\end{tikzpicture}
\end{center}
\note{Today we are working on hardware troubleshooting}
\end{frame}
...
\Large K-1.NSD.3: I can share what troubleshooting is and think of common ways to work through these problems.
\end{block}
\vspace{0.15cm}
{\large\bfseries\color{coral} Success looks like this:}
\begin{itemize}\large
\item K-1.NSD.3: I can share what troubleshooting is and think of common ways to work through these problems.
\item K-1.DL.4: I can use Seesaw to create a digital piece of work (artifact).
