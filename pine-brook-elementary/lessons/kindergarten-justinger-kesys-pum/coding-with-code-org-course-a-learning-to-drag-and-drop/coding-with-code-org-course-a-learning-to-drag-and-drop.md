# 🟡 Coding with code.org | (Course A) | Learning to Drag & Drop
...
- **LaTeX source:** [coding-with-code-org-course-a-learning-to-drag-and-drop.tex](./coding-with-code-org-course-a-learning-to-drag-and-drop.tex)
- **Bib file:** [coding-with-code-org-course-a-learning-to-drag-and-drop.bib](./coding-with-code-org-course-a-learning-to-drag-and-drop.bib)
- **Audience profile:** [class-audience-profile.md](../class-audience-profile.md)
- **Student slides (LaTeX):** [coding-with-code-org-course-a-learning-to-drag-and-drop-slides.tex](./coding-with-code-org-course-a-learning-to-drag-and-drop-slides.tex)
- **Student slides (PDF):** [coding-with-code-org-course-a-learning-to-drag-and-drop-slides.pdf](./coding-with-code-org-course-a-learning-to-drag-and-drop-slides.pdf)

## 🎯 School Planning Goals + Inclusion

- **What is expected:** K-1.IC.2: I can explain classroom chromebook expectations | K-1.CT.4: I can decompose a task into smaller steps | K-1.CT.9: I can fix (debug) mistakes in an algorithm | K-1.CT.10: I can create a plan (algorithm) that shows steps to complete a task.
...
- Today we are working on coding with code.org | (course a) | learning to drag & drop. Watch first, then try it with me.
