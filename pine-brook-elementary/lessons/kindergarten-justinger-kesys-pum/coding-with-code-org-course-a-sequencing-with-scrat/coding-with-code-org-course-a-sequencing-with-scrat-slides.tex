...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Coding with code.org | (Course A) | Sequencing with Scrat\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on coding with code.org | (course a) | sequencing with scrat. Watch first, then try it with me.
