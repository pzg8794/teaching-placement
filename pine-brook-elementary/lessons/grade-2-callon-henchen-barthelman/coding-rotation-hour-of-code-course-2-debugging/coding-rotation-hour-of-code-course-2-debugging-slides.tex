...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Coding Rotation | Hour of Code | Course 2 Debugging\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on coding rotation | hour of code | course 2 debugging. Watch first, then try it with me.
