...
\end{tikzpicture}
\end{center}
\note{Today we are working on block coding with bees}
\end{frame}
...
\Large I can decompose a problem into smaller steps, in multiple ways
\end{block}
\begin{itemize}\large
\item I can decompose a problem into smaller steps, in multiple ways
\item I can identify the essential information needed to get the Bee to the hive.
\item I can code using fixed and changing pieces of information.
\end{itemize}
\column{0.4\textwidth}
