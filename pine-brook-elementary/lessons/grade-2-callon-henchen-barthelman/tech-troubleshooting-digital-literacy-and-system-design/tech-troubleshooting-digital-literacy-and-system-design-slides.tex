...
\end{tikzpicture}
\end{center}
\note{Today we are working on tech troubleshooting: | digital}
\end{frame}
...
\Large I can tell the difference between hardware and software.
\end{block}
\begin{itemize}\large
\item I can tell the difference between hardware and software.
\item I can explain how software is used in computing systems.
