...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Tech Troubleshooting: | Digital Literacy and System Design\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on tech troubleshooting: | digital literacy and system design. Watch first, then try it with me.
