...
\title{Getting Around Town, Day 1}
...
\vspace{0.55cm}
\begin{center}
{\Huge\bfseries\color{ink} Getting Around Town, Day 1\par}
\vspace{0.15cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on getting around town, day}
\end{frame}
...
\Large I can give clear directions, using transitions words to get Indi from one place to another in the community.
\end{block}
\begin{itemize}\large
\item I can give clear directions, using transitions words to get Indi from one place to another in the community.
\item I can write my directions out and create a coding card for my algorithm.
\item I can test my algorithm to find and fix errors in my algorithm.
\end{itemize}
\column{0.4\textwidth}
