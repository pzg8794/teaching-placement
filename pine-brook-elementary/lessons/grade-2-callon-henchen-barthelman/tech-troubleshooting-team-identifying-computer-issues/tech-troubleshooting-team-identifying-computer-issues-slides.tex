...
\end{tikzpicture}
\end{center}
\note{Today we are working on tech troubleshooting team: identifying}
\end{frame}
...
\Large I can identify different types of hardware and software problems.
\end{block}
\begin{itemize}\large
\item I can identify different types of hardware and software problems.
\item I can be proactive and think of ways to prevent some hardware issues.
