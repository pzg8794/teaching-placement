...
\item Reference file: tech-troubleshooting-team-identifying-computer-issues.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: I can identify different types of hardware and software problems. | I can be proactive and think of ways to prevent some hardware issues.
