...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Flex Day - Complete Previous Assignments | Option: | STEM Wheels Challenges Lessons\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on flex day - complete previous assignments | option: | stem wheels challenges lessons. Watch first, then try it with me.
