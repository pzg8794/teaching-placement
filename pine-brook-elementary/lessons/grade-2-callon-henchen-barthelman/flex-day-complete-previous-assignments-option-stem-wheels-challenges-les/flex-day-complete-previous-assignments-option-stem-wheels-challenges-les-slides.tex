...
\vspace{0.55cm}
\begin{center}
{\Huge\bfseries\color{ink} Flex Day - Complete Previous Assignments | Option: | STEM Wheels Challenges Lessons\par}
\vspace{0.15cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on flex day - complete}
\end{frame}
...
\Large "I can design and build a contraption that will meet the requirements of the assignment and fit in the required work area.
\end{block}
\begin{itemize}\large
\item "I can design and build a contraption that will meet the requirements of the assignment and fit in the required work area.
\item I can rethink my ideas to improve my design.
\item I can communicate my ideas.
\end{itemize}
\column{0.4\textwidth}
...
\node[rounded corners=14pt, fill=berrypop!14, draw=berrypop!85, minimum width=3.1cm, minimum height=2.0cm, text width=2.4cm, align=center] (s1) {\Large\bfseries STEP 1\\[4pt]Break the design process into plan, build,};
...
\foreach \y/\txt/\col in {3.85/Some groups need support organizing materials and sticking with one plan/berrypop,2.7/Explaining the design can be harder than making it without sentence/goldpop,1.55/Students may not know they are done/tealpop} {
