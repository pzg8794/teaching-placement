...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Tech Troubleshooting Team:Solving Chromebook Issues\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on tech troubleshooting team:solving chromebook issues. Watch first, then try it with me.
