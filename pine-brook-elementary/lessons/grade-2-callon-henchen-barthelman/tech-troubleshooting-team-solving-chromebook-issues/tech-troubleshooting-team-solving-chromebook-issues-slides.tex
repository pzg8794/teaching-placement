...
\end{tikzpicture}
\end{center}
\note{Today we are working on tech troubleshooting team:solving chromebook}
\end{frame}
...
\Large I can research a common technology issue and find a solution.
\end{block}
\begin{itemize}\large
\item I can research a common technology issue and find a solution.
\item I can describe how to solve a simple technology problem.
\item I can save a file to a specific location in my Google Drive
\end{itemize}
\column{0.4\textwidth}
