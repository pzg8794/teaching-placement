...
\vspace{0.55cm}
\begin{center}
{\Huge\bfseries\color{ink} Technology Changed The World\par}
\vspace{0.15cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on technology changed the world}
\end{frame}
...
\Large I can identify how computing technology has changed the way people live and work.
\end{block}
\begin{itemize}\large
\item I can identify how computing technology has changed the way people live and work.
\item I can explain rules related to using the internet.
\item I can explain how computing technology can be used (in society and the world).
\end{itemize}
\column{0.4\textwidth}
