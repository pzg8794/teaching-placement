...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Technology Changed The World\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on technology changed the world. Watch first, then try it with me.
