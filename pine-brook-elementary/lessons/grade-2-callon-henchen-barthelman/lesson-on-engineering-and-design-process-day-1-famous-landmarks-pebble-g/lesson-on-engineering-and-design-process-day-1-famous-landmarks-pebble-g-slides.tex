...
\title{Lesson on Engineering \& Design Process, Day 1 (Famous Landmarks, Pebble Go)}
...
{\huge\bfseries\color{ink} Lesson on Engineering \& Design Process, Day 1 (Famous Landmarks, Pebble Go)\par}
\vspace{0.2cm}
