...
\end{tikzpicture}
\end{center}
\note{Today we are working on lesson on engineering \&}
\end{frame}
...
\Large I can learn about famous landmarks, identify their key features, and design and build their own models using various materials.
\end{block}
\begin{itemize}\large
\item I can learn about famous landmarks, identify their key features, and design and build their own models using various materials.
