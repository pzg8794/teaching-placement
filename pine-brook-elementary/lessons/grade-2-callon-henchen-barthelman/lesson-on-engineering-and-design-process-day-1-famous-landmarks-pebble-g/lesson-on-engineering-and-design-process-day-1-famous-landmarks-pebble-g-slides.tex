...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Lesson on Engineering \& Design Process, Day 1 (Famous Landmarks, Pebble Go)\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on lesson on engineering \& design process, day 1 (famous landmarks, pebble go). Watch first, then try it with me.
