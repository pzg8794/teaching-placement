...
\item Reference file: lesson-on-engineering-and-design-process-day-1-famous-landmarks-pebble-g.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: I can learn about famous landmarks, identify their key features, and design and build their own models using various materials.
