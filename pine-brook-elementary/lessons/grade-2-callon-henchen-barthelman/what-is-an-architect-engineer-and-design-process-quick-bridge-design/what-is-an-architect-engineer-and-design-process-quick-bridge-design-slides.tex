...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge What is an architect/ engineer \& Design Process- Quick Bridge Design\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on what is an architect/ engineer \& design process- quick bridge design. Watch first, then try it with me.
