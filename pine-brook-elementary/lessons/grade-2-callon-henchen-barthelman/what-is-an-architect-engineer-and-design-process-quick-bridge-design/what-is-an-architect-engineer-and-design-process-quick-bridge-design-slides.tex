...
\title{What is an architect/ engineer \& Design Process- Quick Bridge Design}
...
{\huge\bfseries\color{ink} What is an architect/ engineer \& Design Process- Quick Bridge Design\par}
\vspace{0.2cm}
...
\end{center}
\end{columns}
\note{Audience guidance: Growing independent learners who can handle more tool variety when routines and choices stay well scaffolded.. Teaching move: Make the challenge criteria visible from the first slide through cleanup.}
\end{frame}
