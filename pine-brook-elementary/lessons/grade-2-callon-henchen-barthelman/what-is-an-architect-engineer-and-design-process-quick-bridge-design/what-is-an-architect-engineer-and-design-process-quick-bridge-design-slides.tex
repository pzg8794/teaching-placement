...
\end{tikzpicture}
\end{center}
\note{Today we are working on what is an architect/}
\end{frame}
...
\Large I can define a choice board and explain its purpose in learning.
\end{block}
\begin{itemize}\large
\item I can define a choice board and explain its purpose in learning.
\item I can describe the function of a QR code and demonstrate how to scan and access information using a QR code.
