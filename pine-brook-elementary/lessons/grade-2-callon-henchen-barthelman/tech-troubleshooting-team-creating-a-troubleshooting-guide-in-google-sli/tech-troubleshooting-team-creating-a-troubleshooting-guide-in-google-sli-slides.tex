...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Tech Troubleshooting Team: Creating a Troubleshooting Guide in Google Slides\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on tech troubleshooting team: creating a troubleshooting guide in google slides. Watch first, then try it with me.
