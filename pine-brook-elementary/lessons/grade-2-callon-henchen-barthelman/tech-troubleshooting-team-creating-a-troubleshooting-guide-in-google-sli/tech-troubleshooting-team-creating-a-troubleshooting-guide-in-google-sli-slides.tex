...
\title{Tech Troubleshooting Team: Creating a Troubleshooting Guide in Google Slides}
...
\vspace{0.55cm}
\begin{center}
{\Huge\bfseries\color{ink} Tech Troubleshooting Team: Creating a Troubleshooting Guide in Google Slides\par}
\vspace{0.15cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on tech troubleshooting team: creating}
\end{frame}
...
\Large I can describe how to solve a simple technology problem.
\end{block}
\begin{itemize}\large
\item I can describe how to solve a simple technology problem.
\item I can create a google slide to share my knowledge with others.
