...
\usepackage{tikz}
\usepackage{hyperref}
\definecolor{pbprimary}{HTML}{2F80ED}
\definecolor{pbsecondary}{HTML}{DCEBFF}
...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Explain 6th special, routine, structure, getting to know you\par}
\vspace{0.3cm}
...
\node[anchor=west, text width=10.2cm] at (0.35,0.68) {\large Grade 2 learners: big steps, clear checks, and one thing at a time.};
\end{tikzpicture}
\end{center}
\end{frame}
...
\footnotesize
\begin{itemize}
\item Today we are working on explain 6th special, routine, structure, getting to know you. Watch first, then try it with me.
