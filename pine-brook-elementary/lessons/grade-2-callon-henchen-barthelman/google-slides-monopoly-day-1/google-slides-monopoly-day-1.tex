...
\item Reference file: google-slides-monopoly-day-1.bib
\end{itemize}
\section*{School Planning Goals and Inclusion}
\begin{itemize}[leftmargin=*]
\item What is expected: I can determine whether I am working in a public, private or shared space. | | I can locate and use the main keys on a keyboard | | I can share my learning and collaborate with others using Google Slides. | | I can discuss features that make Google Slides easy or difficult to use.
