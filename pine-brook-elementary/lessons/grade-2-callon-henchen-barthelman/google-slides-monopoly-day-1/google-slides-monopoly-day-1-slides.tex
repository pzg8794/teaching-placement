...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Google Slides Monopoly | (Day 1)\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on google slides monopoly | (day 1). Watch first, then try it with me.
