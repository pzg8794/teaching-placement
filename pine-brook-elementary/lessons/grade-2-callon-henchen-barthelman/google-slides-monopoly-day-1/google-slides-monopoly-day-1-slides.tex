...
\title{Google Slides Monopoly | (Day 1)}
...
\vspace{0.55cm}
\begin{center}
{\Huge\bfseries\color{ink} Google Slides Monopoly | (Day 1)\par}
\vspace{0.15cm}
...
\end{tikzpicture}
\end{center}
\note{Today we are working on google slides monopoly |}
\end{frame}
...
\Large I can determine whether I am working in a public, private or shared space.
\end{block}
\begin{itemize}\large
\item I can determine whether I am working in a public, private or shared space.
\item I can locate and use the main keys on a keyboard
\item I can share my learning and collaborate with others using Google Slides.
\end{itemize}
\column{0.4\textwidth}
...
\node[rounded corners=14pt, fill=berrypop!14, draw=berrypop!85, minimum width=3.1cm, minimum height=2.0cm, text width=2.4cm, align=center] (s1) {\Large\bfseries STEP 1\\[4pt]Model the first screen and the exact};
\node[rounded corners=14pt, fill=goldpop!18, draw=goldpop!80!black, minimum width=3.1cm, minimum height=2.0cm, text width=2.4cm, align=center, right=of s1] (s2) {\Large\bfseries STEP 2\\[4pt]Use sentence frames or model examples when};
...
\foreach \y/\txt/\col in {3.85/Tool navigation can overshadow the content goal if too many options/berrypop,2.7/Directions can feel hidden/goldpop,1.55/Students may not know they are done/tealpop} {
