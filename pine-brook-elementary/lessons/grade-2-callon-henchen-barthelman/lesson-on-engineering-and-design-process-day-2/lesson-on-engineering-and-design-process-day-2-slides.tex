...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Lesson on Engineering \& Design Process, Day 2\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on lesson on engineering \& design process, day 2. Watch first, then try it with me.
