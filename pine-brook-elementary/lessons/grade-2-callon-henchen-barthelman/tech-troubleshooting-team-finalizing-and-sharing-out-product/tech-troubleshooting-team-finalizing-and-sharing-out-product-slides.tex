...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Tech Troubleshooting Team: Finalizing \& sharing out product\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on tech troubleshooting team: finalizing \& sharing out product. Watch first, then try it with me.
