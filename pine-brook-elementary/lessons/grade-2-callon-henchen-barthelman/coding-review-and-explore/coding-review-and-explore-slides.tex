...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Coding Review and explore\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on coding review and explore. Watch first, then try it with me.
