...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Indi: Giving directions \& transition word\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on indi: giving directions \& transition word. Watch first, then try it with me.
