...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Robotics and Digital Book Project\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on robotics and digital book project. Watch first, then try it with me.
