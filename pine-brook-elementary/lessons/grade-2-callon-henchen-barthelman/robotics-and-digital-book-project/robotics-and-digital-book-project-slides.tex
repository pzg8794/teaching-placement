...
\end{tikzpicture}
\end{center}
\note{Today we are working on robotics and digital book}
\end{frame}
...
\node[draw=tealpop!80!black, fill=tealpop!14, rounded corners=10pt, minimum width=3.4cm, minimum height=0.9cm, text width=3.0cm, align=center] at (2.3,0.95) {\scriptsize Grade 2};
\end{tikzpicture}
\end{columns}
\note{Today we are working on robotics and digital book}
\end{frame}
