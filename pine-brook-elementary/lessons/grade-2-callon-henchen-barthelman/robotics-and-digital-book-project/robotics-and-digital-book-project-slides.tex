...
{\huge\bfseries\color{ink} Robotics and Digital Book Project\par}
\vspace{0.2cm}
...
\normalsize Robotics routines, digital storytelling, and explanatory products
\end{block}
\vspace{0.1cm}
\begin{itemize}
\large
...
\begin{itemize}
\large
\item Open with a short model that names the lesson focus: robotics
