...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge AI for Oceans and Robotics\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on ai for oceans and robotics. Watch first, then try it with me.
