...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Jobs and Skills in Computer Science\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on jobs and skills in computer science. Watch first, then try it with me.
