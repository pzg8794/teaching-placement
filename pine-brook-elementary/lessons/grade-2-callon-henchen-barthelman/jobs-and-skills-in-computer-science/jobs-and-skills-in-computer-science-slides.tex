...
\end{tikzpicture}
\end{center}
\note{Watch first, then try it with me}
\end{frame}
...
\Large I can identify a variety of jobs that use computers and computer technologies.
\end{block}
\begin{itemize}\large
\item I can identify a variety of jobs that use computers and computer technologies.
\item I can explore the skills needed to succeed in the field of computer science.
\item I can consider how to use computer programming to solve a problem in society.
\end{itemize}
\column{0.4\textwidth}
