...
\begin{frame}[plain]
\begin{center}
{\usebeamerfont{title}\color{pbprimary}\Huge Hour of Code Assign Course 2 Lesson 3 Sequencing\par}
\vspace{0.3cm}
...
\footnotesize
\begin{itemize}
\item Today we are working on hour of code assign course 2 lesson 3 sequencing. Watch first, then try it with me.
