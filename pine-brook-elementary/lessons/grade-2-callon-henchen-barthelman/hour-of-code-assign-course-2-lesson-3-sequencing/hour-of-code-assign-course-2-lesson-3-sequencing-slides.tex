...
\end{tikzpicture}
\end{center}
\note{Today we are working on hour of code assign}
\end{frame}
...
\Large I can create two or more algorithms for the same task.
\end{block}
\begin{itemize}\large
\item I can create two or more algorithms for the same task.
\item I can identify and debug errors within an algorithm or program that includes.
\item I can develop and document a plan that outlines specific steps taken to complete a project.
\end{itemize}
\column{0.4\textwidth}
