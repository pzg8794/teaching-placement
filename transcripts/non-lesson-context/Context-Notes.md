# 🧭 Non-Lesson Transcript Context Notes

**Color Code:** ⚪ Transcripts

> **📌 What This Is:** Non-lesson transcript notes that still matter for planning, reflection, placement logistics, or future writing.
> **🧭 Start Here When:** You remember a meeting, a placement conversation, or a reflective moment, but it was not an actual class lesson.
> **👀 Best Use:** Open the summarized `.md` note first. Use the raw `.txt` only if you need the original wording later.
